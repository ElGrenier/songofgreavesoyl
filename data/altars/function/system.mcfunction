...
#execute as @e[tag=Altars,scores={Loading=..101}] at @s if entity @a[distance=..3,scores={Team=1,tag=!cannot_capture_altars}] run scoreboard players add @s Loading 1
execute as @e[tag=Altars,scores={Loading=..101}] at @s store result score @s Besiegers if entity @a[distance=..3,tag=!cannot_capture_altars,scores={Team=1}]
execute as @e[tag=Altars,scores={Loading=..101}] at @s run scoreboard players operation @s Loading += @s Besiegers
execute as @e[tag=Altars,scores={Assault=1,Team=-1,Loading=..101}] at @s if entity @a[distance=..3,tag=!cannot_capture_altars,scores={Team=1}] run scoreboard players set @s Assault2 1
execute as @e[tag=Altars,scores={Team=-1,Loading=..101}] at @s if entity @a[distance=..3,tag=!cannot_capture_altars,scores={Team=1}] run scoreboard players set @s Assault 1

# Obleganie - druzyna zolta
#execute as @e[tag=Altars,scores={Loading=-101..}] at @s if entity @a[distance=..3,scores={Team=-1},tag=!cannot_capture_altars] run scoreboard players remove @s Loading 1
execute as @e[tag=Altars,scores={Loading=-101..}] at @s store result score @s Besiegers if entity @a[distance=..3,tag=!cannot_capture_altars,scores={Team=-1}]
execute as @e[tag=Altars,scores={Loading=-101..}] at @s run scoreboard players operation @s Loading -= @s Besiegers
execute as @e[tag=Altars,scores={Assault=1,Team=1,Loading=-101..}] at @s if entity @a[distance=..3,tag=!cannot_capture_altars,scores={Team=-1}] run scoreboard players set @s Assault2 1
execute as @e[tag=Altars,scores={Team=1,Loading=-101..}] at @s if entity @a[distance=..3,tag=!cannot_capture_altars,scores={Team=-1}] run scoreboard players set @s Assault 1
...
execute as @e[tag=Altars,scores={Team=1}] at @s unless entity @a[distance=..3,tag=!cannot_capture_altars,scores={Team=-1}] run scoreboard players set @s Loading 101
execute as @e[tag=Altars,scores={Team=1}] at @s unless entity @a[distance=..3,tag=!cannot_capture_altars,scores={Team=-1}] run scoreboard players set @s Assault 0
...
execute as @e[tag=Altars,scores={Team=0}] at @s unless entity @a[distance=..3,tag=!cannot_capture_altars] run scoreboard players set @s Loading 0
