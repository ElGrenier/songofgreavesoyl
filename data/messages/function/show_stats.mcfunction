...
execute if score map_type settings matches 1 as @a run tellraw @s [{text:"> ",color:"gold",bold:1b,type:"text"},{text:" Altars captured: ",color:"aqua",type:"text"},{score:{name:"@s",objective:"StatCaptured"},color:"dark_aqua",bold:1b,type:"score"},{text:"",color:"aqua",type:"text"}]
execute if score map_type settings matches 3 as @a run tellraw @s [{text:"> ",color:"gold",bold:1b,type:"text"},{text:" Flags captured: ",color:"aqua",type:"text"},{score:{name:"@s",objective:"StatFlagCaptured"},color:"dark_aqua",bold:1b,type:"score"},{text:"",color:"aqua",type:"text"}]
