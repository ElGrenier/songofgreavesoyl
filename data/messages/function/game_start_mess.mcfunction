...
execute if score map settings matches 18 run tellraw @a [{text:"      ",color:"dark_gray",italic:1b,type:"text"},{text:" Cer, we need to kill ",color:"gray",italic:1b,type:"text"},{text:"      ",color:"dark_gray",italic:1b,type:"text"}]
