...
execute if score -wave crawlers_wave matches -208..151 as @a[scores={char=1..}] at @n[tag=crawlers_centre] run tp @s ~ ~ ~
...
#wave 1
execute if score -wave crawlers_wave matches 3 run tellraw @a[scores={char=1..}] {text:"Wave 1:",color:"dark_green",bold:true}
...
execute if score -wave crawlers_wave matches 605 unless entity @e[tag=crawlers_enemy] run execute at @n[tag=crawlers_campfire] run playsound minecraft:entity.player.levelup master @a[scores={char=1..},distance=..40] ~ ~ ~ 3 0.8

#wave 2
execute if score -wave crawlers_wave matches 803 run tellraw @a[scores={char=1..}] {text:"Wave 2:",color:"dark_green",bold:true}
execute if score -wave crawlers_wave matches 803 run tellraw @a[scores={char=1..}] {text:"Crawlers",color:"red",hover_event:{action:"show_text",value:[{text:"Crawler",color:"red"},{text:"\n"},{text:"10 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator",color:"gray"}]}}
execute if score -wave crawlers_wave matches 803 run tellraw @a[scores={char=1..}] {text:"Diggers",color:"red",hover_event:{action:"show_text",value:[{text:"Digger",color:"red"},{text:"\n"},{text:"8 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.",color:"gray"}]}}
...
#wave 3
execute if score -wave crawlers_wave matches 1303 run tellraw @a[scores={char=1..}] {text:"Wave 3:",color:"dark_green",bold:true}
...
#wave 4
execute if score -wave crawlers_wave matches 2103 run tellraw @a[scores={char=1..}] {text:"Wave 4:",color:"dark_green",bold:true}
execute if score -wave crawlers_wave matches 2103 run tellraw @a[scores={char=1..}] {text:"Large Crawlers",color:"red",hover_event:{action:"show_text",value:[{text:"Large Crawler",color:"red"},{text:"\n"},{text:"17 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator",color:"gray"}]}}
execute if score -wave crawlers_wave matches 2103 run tellraw @a[scores={char=1..}] {text:"Large Diggers",color:"red",hover_event:{action:"show_text",value:[{text:"Large Digger",color:"red"},{text:"\n"},{text:"15 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.",color:"gray"}]}}
...
#wave 5
execute if score -wave crawlers_wave matches 2803 run tellraw @a[scores={char=1..}] {text:"Wave 5:",color:"dark_green",bold:true}
...
execute if score -wave crawlers_wave matches 2803 run tellraw @a[scores={char=1..}] {text:"Large Crawlers",color:"red",hover_event:{action:"show_text",value:[{text:"Large Crawler",color:"red"},{text:"\n"},{text:"17 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator",color:"gray"}]}}
execute if score -wave crawlers_wave matches 2803 run tellraw @a[scores={char=1..}] {text:"Diggers",color:"red",hover_event:{action:"show_text",value:[{text:"Digger",color:"red"},{text:"\n"},{text:"8 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.",color:"gray"}]}}
