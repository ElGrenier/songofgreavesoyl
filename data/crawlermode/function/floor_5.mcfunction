...
#wave 1
execute if score -wave crawlers_wave matches 3 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Wave 16:",color:"dark_green",bold:true}
...
execute if score -wave crawlers_wave matches 3 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Hatchers",color:"red",hover_event:{action:"show_text",value:[{text:"Hatcher",color:"red"},{text:"\n"},{text:"25 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator\nInstead of running into it, produces Hatchlings from a distance",color:"gray"}]}}
execute if score -wave crawlers_wave matches 3 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Hatchlings",color:"red",hover_event:{action:"show_text",value:[{text:"Hatchling",color:"red"},{text:"\n"},{text:"6 Health | Quick Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator.",color:"gray"}]}}
...
execute if score -wave crawlers_wave matches 3 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Mothers",color:"red",hover_event:{action:"show_text",value:[{text:"Mother",color:"red"},{text:"\n"},{text:"16 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.\nErupts into 4 Crawlers after death.",color:"gray"}]}}
...
#wave 2
execute if score -wave crawlers_wave matches 803 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Wave 17:",color:"dark_green",bold:true}
execute if score -wave crawlers_wave matches 803 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Spider Jockeys",color:"red",hover_event:{action:"show_text",value:[{text:"Crawler Jockey",color:"red"},{text:"\n"},{text:"30/10 Health | Decent Speed/Fast Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator. \nThe rider makes its mount immune to damage.\nOnce the rider is killed, the mount speeds up greatly.",color:"gray"}]}}
...
#wave 3
execute if score -wave crawlers_wave matches 1303 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Wave 18:",color:"dark_green",bold:true}
...
execute if score -wave crawlers_wave matches 1303 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Spider Jockeys",color:"red",hover_event:{action:"show_text",value:[{text:"Crawler Jockey",color:"red"},{text:"\n"},{text:"30/10 Health | Decent Speed/Fast Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator. \nThe rider makes its mount immune to damage.\nOnce the rider is killed, the mount speeds up greatly.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 1303 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Mothers",color:"red",hover_event:{action:"show_text",value:[{text:"Mother",color:"red"},{text:"\n"},{text:"16 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.\nErupts into 4 Crawlers after death.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 1303 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Spitters",color:"red",hover_event:{action:"show_text",value:[{text:"Spitter",color:"red"},{text:"\n"},{text:"5 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.\nLatches onto the ceiling, coming down only after shooting 3 silencing web spits.",color:"gray"}]}}
...
#wave 4
execute if score -wave crawlers_wave matches 2103 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Wave 19:",color:"dark_green",bold:true}
...
execute if score -wave crawlers_wave matches 2103 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Hatchlings",color:"red",hover_event:{action:"show_text",value:[{text:"Hatchling",color:"red"},{text:"\n"},{text:"6 Health | Quick Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 2103 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Mothers",color:"red",hover_event:{action:"show_text",value:[{text:"Mother",color:"red"},{text:"\n"},{text:"16 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.\nErupts into 4 Crawlers after death.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 2103 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Spitters",color:"red",hover_event:{action:"show_text",value:[{text:"Spitter",color:"red"},{text:"\n"},{text:"5 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.\nLatches onto the ceiling, coming down only after shooting 3 silencing web spits.",color:"gray"}]}}
...
#wave 5
execute if score -wave crawlers_wave matches 2803 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Wave 20:",color:"dark_green",bold:true}
...
execute if score -wave crawlers_wave matches 2803 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Chargers",color:"red",hover_event:{action:"show_text",value:[{text:"Charger",color:"red"},{text:"\n"},{text:"42 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players.\nUnburrows from the ceiling\nDeals heavy damage to any player near small area.\nDashes thrice, then charges up and stuns all nearby players.",color:"gray"}]}}
...
#wave 6
execute if score -wave crawlers_wave matches 4103 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Wave 21:",color:"dark_green",bold:true}
execute if score -wave crawlers_wave matches 4103 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Crawlers",color:"red",hover_event:{action:"show_text",value:[{text:"Crawler",color:"red"},{text:"\n"},{text:"10 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator",color:"gray"}]}}
execute if score -wave crawlers_wave matches 4103 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Large Crawlers",color:"red",hover_event:{action:"show_text",value:[{text:"Large Crawler",color:"red"},{text:"\n"},{text:"17 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator",color:"gray"}]}}
...
execute if score -wave crawlers_wave matches 4605 unless entity @e[tag=crawlers_enemy] run execute at @n[tag=crawlers_campfire] run playsound minecraft:entity.player.levelup master @a[scores={char=1..},tag=!waiting_respawn,distance=..40] ~ ~ ~ 3 0.8

#wave 7
execute if score -wave crawlers_wave matches 4703 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Wave 22:",color:"dark_green",bold:true}
execute if score -wave crawlers_wave matches 4703 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Hatchers",color:"red",hover_event:{action:"show_text",value:[{text:"Hatcher",color:"red"},{text:"\n"},{text:"25 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator\nInstead of running into it, produces Hatchlings from a distance",color:"gray"}]}}
execute if score -wave crawlers_wave matches 4703 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Hatchlings",color:"red",hover_event:{action:"show_text",value:[{text:"Hatchling",color:"red"},{text:"\n"},{text:"6 Health | Quick Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 4703 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Chargers",color:"red",hover_event:{action:"show_text",value:[{text:"Charger",color:"red"},{text:"\n"},{text:"42 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players.\nUnburrows from the ceiling\nDeals heavy damage to any player near small area.\nDashes thrice, then charges up and stuns all nearby players.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 4703 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Spitters",color:"red",hover_event:{action:"show_text",value:[{text:"Spitter",color:"red"},{text:"\n"},{text:"5 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.\nLatches onto the ceiling, coming down only after shooting 3 silencing web spits.",color:"gray"}]}}
...
execute if score -wave crawlers_wave matches 5405 unless entity @e[tag=crawlers_enemy] run execute at @n[tag=crawlers_campfire] run playsound minecraft:entity.player.levelup master @a[scores={char=1..},tag=!waiting_respawn,distance=..40] ~ ~ ~ 3 0.8

#wave 8
execute if score -wave crawlers_wave matches 5503 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Wave 23:",color:"dark_green",bold:true}
execute if score -wave crawlers_wave matches 5503 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Hatchers",color:"red",hover_event:{action:"show_text",value:[{text:"Hatcher",color:"red"},{text:"\n"},{text:"25 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator\nInstead of running into it, produces Hatchlings from a distance",color:"gray"}]}}
execute if score -wave crawlers_wave matches 5503 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Hatchlings",color:"red",hover_event:{action:"show_text",value:[{text:"Hatchling",color:"red"},{text:"\n"},{text:"6 Health | Quick Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 5503 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Spider Jockeys",color:"red",hover_event:{action:"show_text",value:[{text:"Crawler Jockey",color:"red"},{text:"\n"},{text:"30/10 Health | Decent Speed/Fast Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator. \nThe rider makes its mount immune to damage.\nOnce the rider is killed, the mount speeds up greatly.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 5503 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Scouts",color:"red",hover_event:{action:"show_text",value:[{text:"Scout",color:"red"},{text:"\n"},{text:"12 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.\nBites into enemies in a short range, slowing them heavily.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 5503 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Spitters",color:"red",hover_event:{action:"show_text",value:[{text:"Spitter",color:"red"},{text:"\n"},{text:"5 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.\nLatches onto the ceiling, coming down only after shooting 3 silencing web spits.",color:"gray"}]}}
...
execute if score -wave crawlers_wave matches 6305 unless entity @e[tag=crawlers_enemy] run execute at @n[tag=crawlers_campfire] run playsound minecraft:entity.player.levelup master @a[scores={char=1..},tag=!waiting_respawn,distance=..40] ~ ~ ~ 3 0.8

#wave 9
execute if score -wave crawlers_wave matches 6303 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Wave 24:",color:"dark_green",bold:true}
execute if score -wave crawlers_wave matches 6303 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Chargers",color:"red",hover_event:{action:"show_text",value:[{text:"Charger",color:"red"},{text:"\n"},{text:"42 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players.\nUnburrows from the ceiling\nDeals heavy damage to any player near small area.\nDashes thrice, then charges up and stuns all nearby players.",color:"gray"}]}}
...
execute if score -wave crawlers_wave matches 6405 unless entity @e[tag=crawlers_enemy] run execute at @n[tag=crawlers_campfire] run playsound minecraft:entity.player.levelup master @a[scores={char=1..},tag=!waiting_respawn,distance=..40] ~ ~ ~ 3 0.8

#wave 10
execute if score -wave crawlers_wave matches 6503 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Wave 25:",color:"dark_green",bold:true}
execute if score -wave crawlers_wave matches 6503 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Crawlers",color:"red",hover_event:{action:"show_text",value:[{text:"Crawler",color:"red"},{text:"\n"},{text:"10 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator",color:"gray"}]}}
execute if score -wave crawlers_wave matches 6503 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Hatchers",color:"red",hover_event:{action:"show_text",value:[{text:"Hatcher",color:"red"},{text:"\n"},{text:"25 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator\nInstead of running into it, produces Hatchlings from a distance",color:"gray"}]}}
execute if score -wave crawlers_wave matches 6503 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Hatchlings",color:"red",hover_event:{action:"show_text",value:[{text:"Hatchling",color:"red"},{text:"\n"},{text:"6 Health | Quick Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 6503 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Spider Jockeys",color:"red",hover_event:{action:"show_text",value:[{text:"Crawler Jockey",color:"red"},{text:"\n"},{text:"30/10 Health | Decent Speed/Fast Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator. \nThe rider makes its mount immune to damage.\nOnce the rider is killed, the mount speeds up greatly.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 6503 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Diggers",color:"red",hover_event:{action:"show_text",value:[{text:"Diggers",color:"red"},{text:"\n"},{text:"8 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 6503 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Scouts",color:"red",hover_event:{action:"show_text",value:[{text:"Scout",color:"red"},{text:"\n"},{text:"12 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.\nBites into enemies in a short range, slowing them heavily.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 6503 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Chargers",color:"red",hover_event:{action:"show_text",value:[{text:"Charger",color:"red"},{text:"\n"},{text:"42 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players.\nUnburrows from the ceiling\nDeals heavy damage to any player near small area.\nDashes thrice, then charges up and stuns all nearby players.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 6503 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Spitters",color:"red",hover_event:{action:"show_text",value:[{text:"Spitter",color:"red"},{text:"\n"},{text:"5 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.\nLatches onto the ceiling, coming down only after shooting 3 silencing web spits.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 6503 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Mothers",color:"red",hover_event:{action:"show_text",value:[{text:"Mother",color:"red"},{text:"\n"},{text:"16 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.\nErupts into 4 Crawlers after death.",color:"gray"}]}}
...
execute if score -wave crawlers_wave matches 8005 unless entity @e[tag=crawlers_enemy] run execute at @n[tag=crawlers_campfire] run playsound minecraft:entity.player.levelup master @a[scores={char=1..},tag=!waiting_respawn,distance=..40] ~ ~ ~ 3 0.8
...
execute if score -wave crawlers_wave matches 8302 run effect give @a[scores={char=1..},tag=!waiting_respawn] slowness 13 8 true
execute if score -wave crawlers_wave matches 8302 as @a[scores={char=1..},tag=!waiting_respawn] run attribute @s jump_strength modifier add crawl1 -10 add_value
execute if score -wave crawlers_wave matches 8302 at @e[tag=crawlers_campfire] run summon marker ~ ~ ~ {Tags:["crawlers_downward"]}
execute if score -wave crawlers_wave matches 8302 as @a[scores={char=1..},tag=!waiting_respawn] run kill @e[tag=crawlers_campfire]
...
execute if score -wave crawlers_wave matches 8312 as @a[scores={char=1..},tag=!waiting_respawn] run execute as @a[scores={char=1..},tag=!waiting_respawn] at @s run tp @s ~ ~-1 ~
execute if score -wave crawlers_wave matches 8322 as @a[scores={char=1..},tag=!waiting_respawn] run execute as @a[scores={char=1..},tag=!waiting_respawn] at @s run tp @s ~ ~-1 ~
execute if score -wave crawlers_wave matches 8332 as @a[scores={char=1..},tag=!waiting_respawn] run execute as @a[scores={char=1..},tag=!waiting_respawn] at @s run tp @s ~ ~-1 ~
execute if score -wave crawlers_wave matches 8342 as @a[scores={char=1..},tag=!waiting_respawn] run execute as @a[scores={char=1..},tag=!waiting_respawn] at @s run tp @s ~ ~-1 ~
execute if score -wave crawlers_wave matches 8352 as @a[scores={char=1..},tag=!waiting_respawn] run execute as @a[scores={char=1..},tag=!waiting_respawn] at @s run tp @s ~ ~-1 ~
execute if score -wave crawlers_wave matches 8362 as @a[scores={char=1..},tag=!waiting_respawn] run execute as @a[scores={char=1..},tag=!waiting_respawn] at @s run tp @s ~ ~-1 ~

execute if score -wave crawlers_wave matches 8370 run effect clear @a[scores={char=1..},tag=!waiting_respawn] slowness
execute if score -wave crawlers_wave matches 8370 as @a[scores={char=1..},tag=!waiting_respawn] run attribute @s jump_strength modifier remove crawl1
execute if score -wave crawlers_wave matches 8370 run tp @a[scores={char=1..},tag=!waiting_respawn] 97 11 -126
