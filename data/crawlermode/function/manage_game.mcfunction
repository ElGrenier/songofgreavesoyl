...
execute if score game_state settings matches 1 run function crawlermode:initialize_settings
...
#Give the game ticket to everyone
execute if score game_state settings matches 2 as @a[tag=in_game] store result score @s ticket run scoreboard players get ticket settings
...
execute if score game_state settings matches 5 if score all_random settings matches 1 as @a[scores={char=0},sort=random,tag=in_game] at @s run function core:main/random/random_generate_char

execute if score game_state settings matches 5 as @a[scores={char=1..},tag=!waiting_room,tag=in_game] run function core:lobby/tp_waiting_room
