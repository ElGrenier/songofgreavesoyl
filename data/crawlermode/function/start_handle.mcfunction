...
execute if score -dif crawlers_dif matches 1 if score -floor crawlers_floor matches 6.. run scoreboard players set -floor crawlers_floor -1
execute if score -dif crawlers_dif matches 1 unless score -floor crawlers_floor matches 6.. run function crawlermode:randomise
