...
execute if score -wave crawlers_wave matches -50 run title @a[scores={char=1..}] title {text:"T",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -48 run title @a[scores={char=1..}] title {text:"Th",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -46 run title @a[scores={char=1..}] title {text:"The",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -44 run title @a[scores={char=1..}] title {text:"The ",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -42 run title @a[scores={char=1..}] title {text:"The B",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -40 run title @a[scores={char=1..}] title {text:"The Br",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -38 run title @a[scores={char=1..}] title {text:"The Bro",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -36 run title @a[scores={char=1..}] title {text:"The Broo",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -34 run title @a[scores={char=1..}] title {text:"The Brood",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -32 run title @a[scores={char=1..}] title {text:"The Broodm",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -30 run title @a[scores={char=1..}] title {text:"The Broodmo",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -28 run title @a[scores={char=1..}] title {text:"The Broodmot",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -26 run title @a[scores={char=1..}] title {text:"The Broodmoth",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -24 run title @a[scores={char=1..}] title {text:"The Broodmothe",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -22..-2 run title @a[scores={char=1..}] title {text:"The Broodmother",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -22 run title @a[scores={char=1..}] subtitle {text:"Queen of The Crawlers",color:"dark_red"}
...
execute if score -dif crawlers_dif matches 1 if score -wave crawlers_wave matches 4370 run scoreboard players set @a[scores={char=1..}] crawlers_end 100
