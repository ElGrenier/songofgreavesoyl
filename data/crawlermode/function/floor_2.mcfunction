...
#wave 1
execute if score -wave crawlers_wave matches 3 run tellraw @a[scores={char=1..}] {text:"Wave 6:",color:"dark_green",bold:true}
...
execute if score -wave crawlers_wave matches 3 run tellraw @a[scores={char=1..}] {text:"Scouts",color:"red",hover_event:{action:"show_text",value:[{text:"Scout",color:"red"},{text:"\n"},{text:"12 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.\nBites into enemies in a short range, slowing them heavily.",color:"gray"}]}}
...
#wave 2
execute if score -wave crawlers_wave matches 803 run tellraw @a[scores={char=1..}] {text:"Wave 7:",color:"dark_green",bold:true}
execute if score -wave crawlers_wave matches 803 run tellraw @a[scores={char=1..}] {text:"Large Crawlers",color:"red",hover_event:{action:"show_text",value:[{text:"Large Crawler",color:"red"},{text:"\n"},{text:"17 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator",color:"gray"}]}}
...
#wave 3
execute if score -wave crawlers_wave matches 1303 run tellraw @a[scores={char=1..}] {text:"Wave 8:",color:"dark_green",bold:true}
execute if score -wave crawlers_wave matches 1303 run tellraw @a[scores={char=1..}] {text:"Diggers",color:"red",hover_event:{action:"show_text",value:[{text:"Digger",color:"red"},{text:"\n"},{text:"8 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 1303 run tellraw @a[scores={char=1..}] {text:"Large Diggers",color:"red",hover_event:{action:"show_text",value:[{text:"Large Digger",color:"red"},{text:"\n"},{text:"15 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 1303 run tellraw @a[scores={char=1..}] {text:"Hatchers",color:"red",hover_event:{action:"show_text",value:[{text:"Hatcher",color:"red"},{text:"\n"},{text:"25 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator\nInstead of running into it, produces Hatchlings from a distance",color:"gray"}]}}
execute if score -wave crawlers_wave matches 1303 run tellraw @a[scores={char=1..}] {text:"Hatchling",color:"red",hover_event:{action:"show_text",value:[{text:"Hatchling",color:"red"},{text:"\n"},{text:"6 Health | Quick Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator.",color:"gray"}]}}
...
#wave 4
execute if score -wave crawlers_wave matches 2103 run tellraw @a[scores={char=1..}] {text:"Wave 9:",color:"dark_green",bold:true}
...
execute if score -wave crawlers_wave matches 2103 run tellraw @a[scores={char=1..}] {text:"Scouts",color:"red",hover_event:{action:"show_text",value:[{text:"Scout",color:"red"},{text:"\n"},{text:"12 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.\nBites into enemies in a short range, slowing them heavily.",color:"gray"}]}}
...
execute if score -wave crawlers_wave matches 2103 run tellraw @a[scores={char=1..}] {text:"Hatchling",color:"red",hover_event:{action:"show_text",value:[{text:"Hatchling",color:"red"},{text:"\n"},{text:"6 Health | Quick Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator.",color:"gray"}]}}
...
#wave 5
execute if score -wave crawlers_wave matches 2803 run tellraw @a[scores={char=1..}] {text:"Wave 10:",color:"dark_green",bold:true}
...
execute if score -wave crawlers_wave matches 2803 run tellraw @a[scores={char=1..}] {text:"Hatchling",color:"red",hover_event:{action:"show_text",value:[{text:"Hatchling",color:"red"},{text:"\n"},{text:"6 Health | Quick Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator.",color:"gray"}]}}
