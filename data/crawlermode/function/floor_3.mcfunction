...
#wave 1
execute if score -wave crawlers_wave matches 3 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Wave 11:",color:"dark_green",bold:true}
...
execute if score -wave crawlers_wave matches 90 run execute at @e[tag=attacker_ceiling_spawnpoint,limit=1,sort=random] run summon marker ~ ~ ~ {Tags:["crawlers_burrow"]}
...
execute if score -wave crawlers_wave matches 420 run execute at @e[tag=attacker_ceiling_spawnpoint,limit=1,sort=random] run summon marker ~ ~ ~ {Tags:["crawlers_burrow_mother"]}
...
#wave 2
execute if score -wave crawlers_wave matches 803 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Wave 12:",color:"dark_green",bold:true}
execute if score -wave crawlers_wave matches 803 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Crawlers",color:"red",hover_event:{action:"show_text",value:[{text:"Large Crawler",color:"red"},{text:"\n"},{text:"17 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator",color:"gray"}]}}
...
execute if score -wave crawlers_wave matches 803 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Mothers",color:"red",hover_event:{action:"show_text",value:[{text:"Mother",color:"red"},{text:"\n"},{text:"16 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.\nErupts into 4 Crawlers after death.",color:"gray"}]}}

execute if score -wave crawlers_wave matches 840 run execute at @e[tag=attacker_ceiling_spawnpoint,limit=1,sort=random] run summon marker ~ ~ ~ {Tags:["crawlers_burrow_mother"]}
execute if score -wave crawlers_wave matches 920 run execute at @e[tag=attacker_ceiling_spawnpoint,limit=1,sort=random] run summon marker ~ ~ ~ {Tags:["crawlers_burrow_mother"]}
execute if score -wave crawlers_wave matches 1090 run execute at @e[tag=attacker_ceiling_spawnpoint,limit=1,sort=random] run summon marker ~ ~ ~ {Tags:["crawlers_burrow_mother"]}
...
execute if score -wave crawlers_wave matches 1190 run scoreboard players set -attacker_small crawler_spawns 0
...
#wave 3
execute if score -wave crawlers_wave matches 1303 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Wave 13:",color:"dark_green",bold:true}
...
execute if score -wave crawlers_wave matches 1330 run execute at @e[tag=attacker_ceiling_spawnpoint,limit=2,sort=random] run summon marker ~ ~ ~ {Tags:["crawlers_burrow_spit"]}
...
execute if score -wave crawlers_wave matches 1880 run execute at @e[tag=attacker_ceiling_spawnpoint,limit=1,sort=random] run summon marker ~ ~ ~ {Tags:["crawlers_burrow_mother"]}
execute if score -wave crawlers_wave matches 1890 run execute at @e[tag=attacker_ceiling_spawnpoint,limit=2,sort=random] run summon marker ~ ~ ~ {Tags:["crawlers_burrow_spit"]}
...
#wave 4
execute if score -wave crawlers_wave matches 2103 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Wave 14:",color:"dark_green",bold:true}
...
#wave 5
execute if score -wave crawlers_wave matches 2803 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Wave 15:",color:"dark_green",bold:true}
...
execute if score -wave crawlers_wave matches 2803 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Hatchlings",color:"red",hover_event:{action:"show_text",value:[{text:"Hatchling",color:"red"},{text:"\n"},{text:"6 Health | Quick Speed",color:"gray"},{text:"\n"},{text:"Attacks the Elevator.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 2803 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Mothers",color:"red",hover_event:{action:"show_text",value:[{text:"Mother",color:"red"},{text:"\n"},{text:"16 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.\nErupts into 4 Crawlers after death.",color:"gray"}]}}
execute if score -wave crawlers_wave matches 2803 run tellraw @a[scores={char=1..},tag=!waiting_respawn] {text:"Spitters",color:"red",hover_event:{action:"show_text",value:[{text:"Spitter",color:"red"},{text:"\n"},{text:"5 Health | Decent Speed",color:"gray"},{text:"\n"},{text:"Attacks the players. \nUnburrows from the ceiling.\nLatches onto the ceiling, coming down only after shooting 3 silencing web spits.",color:"gray"}]}}


execute if score -wave crawlers_wave matches 2830 run execute at @e[tag=attacker_ceiling_spawnpoint,limit=1,sort=random] run summon marker ~ ~ ~ {Tags:["crawlers_burrow_scout"]}
execute if score -wave crawlers_wave matches 3050 run execute at @e[tag=attacker_ceiling_spawnpoint,limit=1,sort=random] run summon marker ~ ~ ~ {Tags:["crawlers_burrow_spit"]}
...
execute if score -wave crawlers_wave matches 3290 run execute at @e[tag=attacker_ceiling_spawnpoint,limit=1,sort=random] run summon marker ~ ~ ~ {Tags:["crawlers_burrow_mother"]}
execute if score -wave crawlers_wave matches 3470 run execute at @e[tag=attacker_ceiling_spawnpoint,limit=2,sort=random] run summon marker ~ ~ ~ {Tags:["crawlers_burrow_spit"]}
execute if score -wave crawlers_wave matches 3890 run execute at @e[tag=attacker_ceiling_spawnpoint,limit=1,sort=random] run summon marker ~ ~ ~ {Tags:["crawlers_burrow_mother"]}


execute if score -wave crawlers_wave matches 2803 run scoreboard players set -attacker_large crawler_spawns 1
execute if score -wave crawlers_wave matches 3980 run scoreboard players set -attacker_large crawler_spawns 0
