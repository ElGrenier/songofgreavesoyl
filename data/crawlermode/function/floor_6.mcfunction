...
execute if score -wave crawlers_wave matches -52 run title @a[scores={char=1..},tag=!waiting_respawn] times 0 20 0
execute if score -wave crawlers_wave matches -52 run title @a[scores={char=1..},tag=!waiting_respawn] title {text:"B",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -50 run title @a[scores={char=1..},tag=!waiting_respawn] title {text:"Br",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -48 run title @a[scores={char=1..},tag=!waiting_respawn] title {text:"Bro",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -46 run title @a[scores={char=1..},tag=!waiting_respawn] title {text:"Broo",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -44 run title @a[scores={char=1..},tag=!waiting_respawn] title {text:"Brood",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -42 run title @a[scores={char=1..},tag=!waiting_respawn] title {text:"Broodm",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -40 run title @a[scores={char=1..},tag=!waiting_respawn] title {text:"Broodmo",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -38 run title @a[scores={char=1..},tag=!waiting_respawn] title {text:"Broodmot",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -36 run title @a[scores={char=1..},tag=!waiting_respawn] title {text:"Broodmoth",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -34 run title @a[scores={char=1..},tag=!waiting_respawn] title {text:"Broodmothe",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -32 run title @a[scores={char=1..},tag=!waiting_respawn] title {text:"Broodmother",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -30 run title @a[scores={char=1..},tag=!waiting_respawn] title {text:"Broodmother ",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -28 run title @a[scores={char=1..},tag=!waiting_respawn] title {text:"Broodmother T",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -26 run title @a[scores={char=1..},tag=!waiting_respawn] title {text:"Broodmother Tw",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -24 run title @a[scores={char=1..},tag=!waiting_respawn] title {text:"Broodmother Twi",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -22 run title @a[scores={char=1..},tag=!waiting_respawn] title {text:"Broodmother Twin",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -20..6 run title @a[scores={char=1..},tag=!waiting_respawn] title {text:"Broodmother Twins",bold:true,underlined:true,color:"red"}
execute if score -wave crawlers_wave matches -20 run title @a[scores={char=1..},tag=!waiting_respawn] subtitle {text:"Double Terror",color:"dark_red"}
...
execute if score -dif crawlers_dif matches 2 if score -wave crawlers_wave matches 4370 run scoreboard players set @a[scores={char=1..},tag=!waiting_respawn] crawlers_end 100
