...
scoreboard players set @a[scores={char=57,s1_timer=1}] spellCD1 160
scoreboard players add @a[scores={s1_timer=1..}] s1_timer 1
scoreboard players set @a[scores={s1_timer=161..}] s1_timer 0

scoreboard players set @a[scores={s2_timer=1}] spellCD2 280
scoreboard players add @a[scores={s2_timer=1..}] s2_timer 1
scoreboard players set @a[scores={s2_timer=281..}] s2_timer 0
...
execute as @a[scores={char=57,s1_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=57}] carrot_on_a_stick
...
execute as @a[scores={char=57,s2_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=57}] warped_fungus_on_a_stick
