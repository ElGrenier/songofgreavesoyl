...
execute at @a[scores={char=25,s1_timer=31..32}] run kill @e[tag=firestream] 
execute at @a[scores={char=25,s1_timer=31..32}] at @e[tag=firenomore] run fill ~15 ~10 ~15 ~-15 ~-10 ~-15 air replace fire
execute at @a[scores={char=25,s1_timer=31..32}] at @e[tag=firenomore] run fill ~15 ~10 ~15 ~-15 ~-10 ~-15 air replace soul_fire
execute at @a[scores={char=25,s1_timer=1..41}] run fill ~1 ~3 ~1 ~-1 ~-3 ~-1 minecraft:air replace minecraft:fire
...
execute as @a[scores={char=25,s1_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=25}] minecraft:carrot_on_a_stick
item replace entity @a[scores={char=25,s1_timer=0}] hotbar.1 with carrot_on_a_stick[custom_data={s1:1},minecraft:item_model="minecraft:campfire",minecraft:custom_name={text:"To Ashes",color:"dark_aqua",bold:1b}] 1

execute as @a[scores={char=25,s2_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=25}] minecraft:warped_fungus_on_a_stick
item replace entity @a[scores={char=25,s2_timer=0}] hotbar.2 with warped_fungus_on_a_stick[custom_data={s2:1},minecraft:item_model="minecraft:netherite_scrap",minecraft:custom_name={text:"Dragon's Descent",color:"dark_aqua",bold:1b}] 1
