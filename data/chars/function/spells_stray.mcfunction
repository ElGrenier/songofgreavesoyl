...
execute as @a[scores={char=33,out_of_combat=180..}] at @s unless entity @e[distance=..5,tag=Altars] unless score @s Team > @e[distance=..5,tag=valid_spell_target,limit=1,sort=furthest] Team unless score @s Team < @e[distance=..5,tag=valid_spell_target,limit=1,sort=furthest] Team run scoreboard players set @s stealth 4
...
execute at @a[scores={stealth=2,char=33}] run particle falling_dust{block_state:{Name:"minecraft:coal_block"}} ~ ~1 ~ 0.5 1 0.5 0.01 40
execute at @a[scores={stealth=1..2,char=33}] run playsound entity.zombie.infect master @a[distance=..10] ~ ~ ~ 1 1 1

effect clear @a[scores={stealth=..2,char=33}] invisibility
...
execute at @a[scores={char=33,s1_timer=2,CC_silence=0}] run playsound entity.wither_skeleton.ambient master @a[distance=..14] ~ ~ ~ 1 0.1 1

execute at @a[scores={char=33,s1_timer=2,CC_silence=0}] as @e[tag=valid_spell_target,distance=..14] at @s unless score @s Team = @p[scores={char=33}] Team run particle falling_dust{block_state:{Name:"minecraft:coal_block"}} ~ ~1.6 ~ 0.3 0.4 0.3 1 50
...
execute at @a[scores={char=33,s2_timer=1}] run playsound entity.player.attack.sweep master @a[distance=..5] ~ ~ ~ 1 1.6 1
execute at @a[scores={char=33,s2_timer=1}] run summon marker ~ ~ ~ {Tags:["stray_slash","entities_stray","projectile"]}
tp @e[tag=stray_slash,limit=1] @a[scores={char=33,s2_timer=1},limit=1]
execute at @a[scores={char=33,s2_timer=1},limit=1] run tp @e[tag=stray_slash,limit=1] ~ ~1.1 ~

execute as @e[tag=stray_slash] at @s unless block ~ ~ ~ #minecraft:dash run kill @s
execute as @e[tag=stray_slash] at @s unless block ^ ^ ^1 #minecraft:dash run kill @s
execute as @e[tag=stray_slash] at @s unless block ^ ^1 ^0.5 #minecraft:dash run kill @s
execute as @e[tag=stray_slash] at @s unless block ^ ^1.5 ^1.5 #minecraft:dash run kill @s
execute as @e[tag=stray_slash] at @s unless block ^ ^1 ^1 #minecraft:dash run kill @s
execute as @e[tag=stray_slash] at @s unless block ^ ^ ^1 #minecraft:dash run kill @s

execute at @e[tag=stray_slash] run particle crit ~ ~ ~ 0.1 0.5 0.1 0 5
execute at @e[tag=stray_slash] run particle sweep_attack ~ ~ ~ 0.5 0.1 0.5 0 3
execute as @e[tag=stray_slash] at @s run tp @s ^ ^ ^0.5
execute at @e[tag=stray_slash] run particle crit ~ ~ ~ 0.1 0.5 0.1 0 5
execute at @e[tag=stray_slash] run particle sweep_attack ~ ~ ~ 0.5 0.1 0.5 0 3
execute as @e[tag=stray_slash] at @s run tp @s ^ ^ ^0.5

execute at @a[scores={char=33,s2_timer=6}] run kill @e[tag=stray_slash]


execute at @e[tag=stray_slash] positioned ~-.5 ~-.5 ~-.5 as @e[dx=0,dy=0,dz=0,tag=valid_spell_target] unless score @s Team = @p[scores={char=33}] Team at @s run tag @s add stray_wounded
execute if entity @e[tag=stray_wounded] run kill @e[tag=stray_slash]


execute at @e[tag=stray_wounded] run particle block{block_state:{Name:"minecraft:nether_wart_block"}} ~ ~1.2 ~ 0.4 0.8 0.4 0.1 20
execute at @e[tag=stray_wounded] run particle crit ~ ~1 ~ 0.4 0.8 0.4 0.1 20
execute at @e[tag=stray_wounded] run playsound entity.player.attack.strong master @a[distance=..8] ~ ~ ~ 1 0.5 1
scoreboard players set @a[tag=stray_wounded] CC_defiled 80
effect give @e[tag=stray_wounded] slowness 1 3
execute at @e[tag=stray_wounded,scores={prey=1..}] run effect give @p[scores={char=33}] speed 2 2 true
damage @e[tag=stray_wounded,limit=1] 4 player_attack by @p[scores={char=33}] from @p[scores={char=33}]
tag @e remove stray_wounded
...
execute as @a[scores={char=33,s3_timer=1,CC_silence=0}] at @s positioned ~ ~1.3 ~ run function chars:stray_prey_raycast
...
execute as @a[scores={stray_terrorradius=80..}] at @s if entity @a[distance=..5,scores={char=33}] run playsound entity.warden.heartbeat master @s ~ ~ ~ 1 1.2 1
execute as @a[scores={stray_terrorradius=80..}] at @s if entity @a[distance=5.1..11,scores={char=33}] run playsound entity.warden.heartbeat master @s ~ ~ ~ 1 1 1
execute as @a[scores={stray_terrorradius=80..}] at @s if entity @a[distance=11.1..,scores={char=33}] run playsound entity.warden.heartbeat master @s ~ ~ ~ 1 0.8 1
...
scoreboard players set @a[scores={s3_timer=1,char=33}] spellCD3 10
scoreboard players add @a[scores={s3_timer=1..,char=33}] s3_timer 1
scoreboard players set @a[scores={s3_timer=11..,char=33}] s3_timer 0
