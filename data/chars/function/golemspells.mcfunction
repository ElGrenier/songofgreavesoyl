kill @e[type=minecraft:item,nbt={Item:{id:"minecraft:hopper"}}]
kill @e[type=minecraft:item,nbt={Item:{id:"minecraft:cauldron"}}]
kill @e[type=minecraft:item,nbt={Item:{id:"minecraft:comparator"}}]
kill @e[type=minecraft:item,nbt={Item:{id:"minecraft:bow"}}]
kill @e[type=minecraft:item,nbt={Item:{id:"minecraft:crossbow"}}]
scoreboard players set @a[scores={char=18,weapondrop_shot=1..}] crossbowcd 1
scoreboard players set @a[scores={char=18,weapondrop_shot=1..}] weapondrop_shot 0
...
execute at @a[scores={char=18,s0_timer=1,CC_silence=0}] run playsound entity.skeleton.shoot master @a[distance=..15] ~ ~ ~ 1 0.5 1
...
execute at @e[tag=golem_projectile] run particle dust{color:[1.0,1.0,1.0],scale:1} ~ ~ ~ 0.4 0.4 0.4 0 3
execute at @e[tag=golem_projectile] run particle soul_fire_flame ~ ~ ~ 0.4 0.4 0.4 0 1
...
item replace entity @a[scores={char=18,s2_timer=60}] armor.head with minecraft:player_head[minecraft:custom_name="Core",minecraft:enchantments={"minecraft:projectile_protection":2,"minecraft:binding_curse":1},minecraft:attribute_modifiers=[{id:"armor",type:"minecraft:max_health",amount:8.0d,operation:"add_value",slot:"head"}],minecraft:profile={id:[I;-2088556085,-83734688,-2129708947,-1030770170],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNDE0YTJlYTIxZDZjOTY5MzhhMjcxZmNmZjUyM2E2NTA3YjQ1NGY4NGJhZDk1OTkzZjQ0OTJhNmZiYzMwOTRmNSJ9fX0="}]}] 1
...
clear @a[tag=sentrymode,scores={char=18,universal_death=1..}] minecraft:barrier
clear @a[tag=sentrymode,scores={char=18,universal_death=1..}] minecraft:cauldron
clear @a[tag=sentrymode,scores={char=18,universal_death=1..}] minecraft:hopper
...
execute at @a[scores={char=18,s1_timer=1}] run playsound minecraft:block.iron_trapdoor.close master @a[distance=..10] ~ ~ ~ 1 0.1 1
...
clear @a[scores={char=18,s1_timer=1}] arrow
clear @a[scores={char=18,s1_timer=1}] bow
...
#cannon mode OFF
execute at @a[scores={char=18,s1_timer_recast=1}] run playsound minecraft:block.iron_trapdoor.open master @a[distance=..10] ~ ~ ~ 1 0.1 1
...
scoreboard players set @a[scores={char=18,s1_timer_recast=1}] crossbowcd 0
scoreboard players set @a[scores={char=18,s1_timer_recast=1}] arrowcd 0
scoreboard players set @a[scores={char=18,s1_timer_recast=1}] arrowcd_1 0
clear @a[scores={char=18,s1_timer_recast=1}] minecraft:crossbow
item replace entity @a[scores={char=18,s1_timer_recast=1}] hotbar.0 with bow[minecraft:custom_name={text:"Cannon",color:"gray",bold:1b},minecraft:unbreakable={}] 1
item replace entity @a[scores={char=18,s1_timer_recast=1}] hotbar.8 with arrow 1
...
execute at @a[scores={char=18,arrowcd_1=..10}] run tag @e[type=minecraft:arrow,distance=..2] add golemshot_ar
execute at @a[tag=sentrymode,scores={char=18}] run data merge entity @e[type=minecraft:arrow,distance=..2,limit=1,nbt={crit:1b}] {crit:0b}
execute at @e[tag=golemshot_ar] run particle firework ~ ~ ~ 0.1 0.1 0.1 0.01 2 force
...
execute as @a[tag=sentrymode,scores={char=18,s1_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=18}] carrot_on_a_stick[custom_data={s1:2}]
item replace entity @a[tag=sentrymode,scores={char=18,s1_timer=0}] hotbar.1 with carrot_on_a_stick[custom_data={s1:2},minecraft:item_model="minecraft:cauldron",minecraft:custom_name={text:"Cancel",color:"dark_aqua",bold:1b}] 1

execute as @a[tag=!sentrymode,scores={char=18,s1_timer_recast=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=18}] carrot_on_a_stick[custom_data={s1:1}]
item replace entity @a[tag=!sentrymode,scores={char=18,s1_timer_recast=0}] hotbar.1 with carrot_on_a_stick[custom_data={s1:1},minecraft:item_model="minecraft:hopper",minecraft:custom_name={text:"Sentry Mode",color:"dark_aqua",bold:1b}] 1

execute as @a[scores={char=18,s2_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=18}] warped_fungus_on_a_stick
item replace entity @a[scores={char=18,s2_timer=0}] hotbar.2 with warped_fungus_on_a_stick[custom_data={s2:1},minecraft:item_model="minecraft:blast_furnace",minecraft:custom_name={text:"Soul Furnace",color:"dark_aqua",bold:1b},minecraft:enchantments={"minecraft:soul_speed":1}] 1