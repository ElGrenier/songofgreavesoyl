...
execute at @a[scores={char=54,s1_timer=1,CC_silence=0}] run playsound entity.guardian.ambient master @a[distance=..15] ~ ~ ~ 0.1 2 1

execute at @a[scores={char=54,s1_timer=1,CC_silence=0}] unless entity @e[distance=1..10,tag=shaman_heal] run scoreboard players set @a[scores={char=54}] spellCD1 10
execute at @a[scores={char=54,s1_timer=1,CC_silence=0}] unless entity @e[distance=1..10,tag=shaman_heal] run scoreboard players set @a[scores={char=54}] s1_timer 130
