...
title @a[scores={char=70,passive_bard=31..32,passive_bard_use=1,CC_silence=0}] actionbar [{"text": "[ ","color": "dark_purple","bold": true},{"text": "Perfect!","color": "gold","bold": false},{"text": " ]","color": "dark_purple","bold": true}]
title @a[scores={char=70,passive_bard=27..30,passive_bard_use=1,CC_silence=0}] actionbar [{"text": "[ ","color": "dark_purple","bold": true},{"text": "Early...","color": "yellow","bold": false},{"text": " ]","color": "dark_purple","bold": true}]
title @a[scores={char=70,passive_bard=33..36,passive_bard_use=1,CC_silence=0}] actionbar [{"text": "[ ","color": "dark_purple","bold": true},{"text": "Late...","color": "yellow","bold": false},{"text": " ]","color": "dark_purple","bold": true}]
title @a[scores={char=70,passive_bard=24..27,passive_bard_use=1,CC_silence=0}] actionbar [{"text": "[ ","color": "dark_purple","bold": true},{"text": "Very Early...","color": "gray","bold": false},{"text": " ]","color": "dark_purple","bold": true}]
title @a[scores={char=70,passive_bard=37..,passive_bard_use=1,CC_silence=0}] actionbar [{"text": "[ ","color": "dark_purple","bold": true},{"text": "Very Late...","color": "gray","bold": false},{"text": " ]","color": "dark_purple","bold": true}]

execute at @a[scores={char=70,passive_bard=31..32,CC_silence=0,passive_bard_use=1,universal_jump=1}] as @a[distance=..4] if score @s Team = @p[scores={char=70}] Team run effect give @s absorption 1 0
execute at @a[scores={char=70,passive_bard=31..32,CC_silence=0,passive_bard_use=1,universal_jump=1}] as @a[distance=..4] if score @s Team = @p[scores={char=70}] Team run effect give @s speed 1 1

scoreboard players add @e[tag=sog_visuals] s0_timer 1

execute at @a[scores={char=70,passive_bard=31..32,CC_silence=0,passive_bard_use=1,universal_jump=1}] run summon marker ~ ~0.25 ~ {Tags:["sog_visual_core","sog_visuals","entities_bard"]}
execute at @a[scores={char=70,passive_bard=31..32,CC_silence=0,passive_bard_use=1,universal_jump=1}] run summon marker ~0.5 ~0.25 ~ {Tags:["sog_visual_1","sog_visuals","entities_bard"]}
execute at @a[scores={char=70,passive_bard=31..32,CC_silence=0,passive_bard_use=1,universal_jump=1}] run summon marker ~-0.5 ~0.25 ~ {Tags:["sog_visual_2","sog_visuals","entities_bard"]}
execute at @a[scores={char=70,passive_bard=31..32,CC_silence=0,passive_bard_use=1,universal_jump=1}] run summon marker ~ ~0.25 ~0.5 {Tags:["sog_visual_3","sog_visuals","entities_bard"]}
execute at @a[scores={char=70,passive_bard=31..32,CC_silence=0,passive_bard_use=1,universal_jump=1}] run summon marker ~ ~0.25 ~-0.5 {Tags:["sog_visual_4","sog_visuals","entities_bard"]}

execute at @e[tag=sog_visuals,tag=!sog_visual_core] run particle scrape ~ ~0.2 ~ 0.2 0.1 0.2 0.000001 15
...
#> song of healing (formerly crescendo)
...
tag @a[scores={char=70,s1_timer=1,passive_bard=31..32,CC_silence=0,passive_bard_use=1}] add bard_s1_perfect
execute at @a[scores={char=70,s1_timer=1,passive_bard=31..32,CC_silence=0,passive_bard_use=1}] run particle end_rod ~ ~1 ~ .25 .4 .25 .1 15
execute at @a[scores={char=70,s1_timer=1,passive_bard=31..32,CC_silence=0,passive_bard_use=1}] run playsound block.note_block.chime master @a[distance=..12] ~ ~ ~ .65 2 1

effect give @a[scores={char=70,s1_timer=1..30,CC_silence=0},tag=bard_s1_perfect] speed 1 2
...
execute at @e[tag=crescendo_range,type=marker,limit=1] run particle dust{color:[.878,.69,1],scale:1.5} ^ ^ ^4 .1 .2 .1 0 10
execute at @e[tag=crescendo_range,type=marker,limit=1] run particle dust{color:[.878,.69,1],scale:1.5} ^ ^ ^-4 .1 .2 .1 0 10
execute at @e[tag=crescendo_range,type=marker,limit=1] run particle dust{color:[.878,.69,1],scale:1.5} ^4 ^ ^ .1 .2 .1 0 10
execute at @e[tag=crescendo_range,type=marker,limit=1] run particle dust{color:[.878,.69,1],scale:1.5} ^-4 ^ ^ .1 .2 .1 0 10
execute at @e[tag=crescendo_range,type=marker,limit=1] run particle dust{color:[.878,.69,1],scale:1.5} ^-3 ^ ^3 .1 .2 .1 0 10
execute at @e[tag=crescendo_range,type=marker,limit=1] run particle dust{color:[.878,.69,1],scale:1.5} ^3 ^ ^-3 .1 .2 .1 0 10
execute at @e[tag=crescendo_range,type=marker,limit=1] run particle dust{color:[.878,.69,1],scale:1.5} ^3 ^ ^3 .1 .2 .1 0 10
execute at @e[tag=crescendo_range,type=marker,limit=1] run particle dust{color:[.878,.69,1],scale:1.5} ^-3 ^ ^-3 .1 .2 .1 0 10
...
execute at @a[scores={char=70,s1_timer=10,CC_silence=0}] run playsound block.note_block.bass master @a[distance=..12] ~ ~ ~ 10 .5 1
execute at @a[scores={char=70,s1_timer=20,CC_silence=0}] run playsound block.note_block.bass master @a[distance=..12] ~ ~ ~ 10 1 1
execute at @a[scores={char=70,s1_timer=30,CC_silence=0}] run playsound block.note_block.bass master @a[distance=..12] ~ ~ ~ 10 1.5 1
execute at @a[scores={char=70,s1_timer=40,CC_silence=0}] run playsound block.note_block.bass master @a[distance=..12] ~ ~ ~ 10 2 1
execute at @a[scores={char=70,s1_timer=50,CC_silence=0}] run playsound block.note_block.guitar master @a[distance=..12] ~ ~ ~ 10 2 1
execute at @a[scores={char=70,s1_timer=50,CC_silence=0},tag=bard_s1_perfect] as @a[distance=..12] unless score @s Team = @p[scores={char=70}] Team run playsound ambient.cave master @s ~ ~ ~ 1 1 1

execute at @a[scores={char=70,s1_timer=50,CC_silence=0}] as @a[distance=..4,scores={CC_defiled=0}] if score @s Team = @p[scores={char=70}] Team run effect give @s regeneration 1 4 true

execute at @a[scores={char=70,s1_timer=50,CC_silence=0},tag=bard_s1_perfect] as @a[distance=..4] unless score @s Team = @p[scores={char=70}] Team run tag @s add bard_fear

tag @a[scores={char=70,s1_timer=50}] remove bard_s1_perfect
...
execute at @a[scores={char=70,s1_timer=50,CC_silence=0}] run summon marker ~ ~0.25 ~ {Tags:["crescendo_visual_core","crescendo_visuals","entities_bard"]}
execute at @a[scores={char=70,s1_timer=50,CC_silence=0}] run summon marker ~0.5 ~0.25 ~ {Tags:["crescendo_visual_1","crescendo_visuals","entities_bard"]}
execute at @a[scores={char=70,s1_timer=50,CC_silence=0}] run summon marker ~-0.5 ~0.25 ~ {Tags:["crescendo_visual_2","crescendo_visuals","entities_bard"]}
execute at @a[scores={char=70,s1_timer=50,CC_silence=0}] run summon marker ~ ~0.25 ~0.5 {Tags:["crescendo_visual_3","crescendo_visuals","entities_bard"]}
execute at @a[scores={char=70,s1_timer=50,CC_silence=0}] run summon marker ~ ~0.25 ~-0.5 {Tags:["crescendo_visual_4","crescendo_visuals","entities_bard"]}
...
execute at @a[scores={char=70,s1_timer=60..}] run kill @e[tag=crescendo_visuals]
...
tag @a[scores={char=70,s2_timer=1,passive_bard=31..32,CC_silence=0,passive_bard_use=1}] add bard_s2_perfect
execute at @a[scores={char=70,s2_timer=1,passive_bard=31..32,CC_silence=0,passive_bard_use=1}] run playsound block.note_block.chime master @a[distance=..12] ~ ~ ~ .65 2 1
execute at @a[scores={char=70,s2_timer=1,passive_bard=31..32,CC_silence=0,passive_bard_use=1}] run particle end_rod ~ ~1 ~ .25 .4 .25 .1 15
...
execute at @e[tag=encore_range,type=marker,limit=1] run particle falling_dust{block_state:ice} ^ ^ ^6 .1 .2 .1 0 10
execute at @e[tag=encore_range,type=marker,limit=1] run particle falling_dust{block_state:ice} ^ ^ ^-6 .1 .2 .1 0 10
execute at @e[tag=encore_range,type=marker,limit=1] run particle falling_dust{block_state:ice} ^6 ^ ^ .1 .2 .1 0 10
execute at @e[tag=encore_range,type=marker,limit=1] run particle falling_dust{block_state:ice} ^-6 ^ ^ .1 .2 .1 0 10
execute at @e[tag=encore_range,type=marker,limit=1] run particle falling_dust{block_state:snow} ^-4.5 ^ ^4.5 .1 .2 .1 0 10
execute at @e[tag=encore_range,type=marker,limit=1] run particle falling_dust{block_state:snow} ^4.5 ^ ^-4.5 .1 .2 .1 0 10
execute at @e[tag=encore_range,type=marker,limit=1] run particle falling_dust{block_state:snow} ^4.5 ^ ^4.5 .1 .2 .1 0 10
execute at @e[tag=encore_range,type=marker,limit=1] run particle falling_dust{block_state:snow} ^-4.5 ^ ^-4.5 .1 .2 .1 0 10
...
execute as @e[tag=valid_spell_target,scores={CC_glaciate=1..}] at @s if data entity @s {HurtTime:10s} run damage @s 1 freeze
...
scoreboard players set @a[scores={s1_timer=1,char=70}] spellCD1 240
scoreboard players add @a[scores={s1_timer=1..,char=70}] s1_timer 1
scoreboard players set @a[scores={s1_timer=241..,char=70}] s1_timer 0

scoreboard players set @a[scores={s2_timer=1,char=70}] spellCD2 360
scoreboard players add @a[scores={s2_timer=1..,char=70}] s2_timer 1
scoreboard players set @a[scores={s2_timer=361..,char=70}] s2_timer 0
...
execute as @a[scores={char=70,s1_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=70}] carrot_on_a_stick[custom_data={s1:1}]
item replace entity @a[scores={char=70,s1_timer=0}] hotbar.1 with carrot_on_a_stick[minecraft:custom_name={"text":"Song of Healing","color":"dark_aqua","bold":true},custom_data={s1:1},item_model="music_disc_precipice"] 1

execute as @a[scores={char=70,s2_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=70}] warped_fungus_on_a_stick[custom_data={s2:1}]
