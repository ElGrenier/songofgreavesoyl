...
execute at @e[scores={char=68,s2_timer=2,CC_silence=0}] run playsound block.beacon.activate master @a[distance=..8] ~ ~ ~ 0.5 2 1
execute at @e[scores={char=68,s2_timer=2,CC_silence=0}] run playsound entity.illusioner.prepare_mirror master @a[distance=..8] ~ ~ ~ 0.3 2 1
...
execute at @e[scores={char=68,s2_timer=2..25,CC_silence=0}] run particle enchanted_hit ~ ~1 ~ 0.5 1 0.5 0.1 10

execute as @e[scores={char=68,s2_timer=21}] run attribute @s knockback_resistance base set 0.0
