...
item replace entity @p[scores={char=67,HPercentage=21..60}] armor.head with player_head[minecraft:custom_name="Head",minecraft:enchantments={"minecraft:projectile_protection":2,"minecraft:binding_curse":1},minecraft:attribute_modifiers=[{id:"armor",type:"minecraft:max_health",amount:10.0d,operation:"add_value",slot:"head"},{id:"armor",type:"minecraft:knockback_resistance",amount:0.025d,operation:"add_value",slot:"head"}],minecraft:profile={id:[I;-1882506042,-1938469333,-1264120337,1864856646],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMjEwNzBkY2Q1NmU4MWUzNGM5ZDQ5NDY1ZjEzMDY0YTFjYzUyNDhmMGM5NTI3ODZhNzRmNGRlYjAxMzQ2Y2E0NiJ9fX0="}]}] 1
...
item replace entity @p[scores={char=67,HPercentage=..20}] armor.head with player_head[minecraft:custom_name="Head",minecraft:enchantments={"minecraft:projectile_protection":2,"minecraft:binding_curse":1},minecraft:attribute_modifiers=[{id:"armor",type:"minecraft:max_health",amount:10.0d,operation:"add_value",slot:"head"},{id:"armor",type:"minecraft:knockback_resistance",amount:0.05d,operation:"add_value",slot:"head"}],minecraft:profile={id:[I;-1882506042,-1938469333,-1264120337,1864856646],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMjEwNzBkY2Q1NmU4MWUzNGM5ZDQ5NDY1ZjEzMDY0YTFjYzUyNDhmMGM5NTI3ODZhNzRmNGRlYjAxMzQ2Y2E0NiJ9fX0="}]}] 1
...
#item replace entity @p[scores={char=67,HPercentage=..25}] armor.head with player_head[minecraft:custom_name="Head",minecraft:enchantments={"minecraft:projectile_protection":2,"minecraft:binding_curse":1},minecraft:attribute_modifiers=[{id:"armor",type:"minecraft:max_health",amount:10.0d,operation:"add_value",slot:"head"},{id:"armor",type:"minecraft:knockback_resistance",amount:0.075d,operation:"add_value",slot:"head"}],minecraft:profile={id:[I;-1882506042,-1938469333,-1264120337,1864856646],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMjEwNzBkY2Q1NmU4MWUzNGM5ZDQ5NDY1ZjEzMDY0YTFjYzUyNDhmMGM5NTI3ODZhNzRmNGRlYjAxMzQ2Y2E0NiJ9fX0="}]}] 1
...
scoreboard players set @a[scores={char=67}] MaxHP 30
