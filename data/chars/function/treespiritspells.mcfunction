kill @e[type=minecraft:item,nbt={Item:{id:"minecraft:oak_sapling"}}]
...
execute as @a[scores={char=16,treespirit_empower=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:wooden_axe",Slot:0b}]}] run clear @a[scores={char=16}] minecraft:wooden_axe
execute as @a[scores={char=16,treespirit_empower=1}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:wooden_shovel",Slot:0b}]}] run clear @a[scores={char=16}] minecraft:wooden_shovel
...
execute as @a[scores={char=16,s1_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=16}] minecraft:carrot_on_a_stick
item replace entity @a[scores={char=16,s1_timer=0}] hotbar.1 with carrot_on_a_stick[custom_data={s1:1},minecraft:item_model="minecraft:pitcher_pod",minecraft:custom_name={text:"Branch Smash",color:"dark_aqua",bold:1b}] 1

execute as @a[scores={char=16,s2_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=16}] minecraft:warped_fungus_on_a_stick
item replace entity @a[scores={char=16,s2_timer=0}] hotbar.2 with warped_fungus_on_a_stick[custom_data={s2:1},minecraft:item_model="minecraft:oak_sapling",minecraft:custom_name={text:"Green Wind",color:"dark_aqua",bold:1b},minecraft:enchantments={"minecraft:protection":1}] 1
