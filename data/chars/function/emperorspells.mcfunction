...
execute at @e[tag=nautilus] as @a[tag=valid_spell_target,distance=..2.5,scores={CC_knockup=0}] at @s unless score @s Team = @p[scores={char=32}] Team run summon marker ~ ~ ~ {Tags:["deepexplosion","entities_emperor"]}

execute at @a[scores={char=32,s1_timer=50..}] run kill @e[tag=nautilus]


execute at @e[tag=deepexplosion] as @a[tag=valid_spell_target,distance=..3,scores={CC_knockup=0}] unless score @s Team = @p[scores={char=32}] Team run scoreboard players set @s CC_knockup 40
...
execute at @a[scores={char=32,s2_timer=1,CC_silence=0}] run summon marker ~ ~ ~ {Tags:["pincers","entities_emperor"]}
...
execute as @a[scores={char=32,s1_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=32}] carrot_on_a_stick
...
execute as @a[scores={char=32,s2_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=32}] warped_fungus_on_a_stick
item replace entity @a[scores={char=32,s2_timer=0}] hotbar.2 with warped_fungus_on_a_stick[custom_data={s2:1},minecraft:item_model="minecraft:netherite_boots",minecraft:custom_name={text:"Crashing Pincers",color:"dark_aqua",bold:1b}] 1
