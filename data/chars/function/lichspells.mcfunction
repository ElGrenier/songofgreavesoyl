...
execute at @a[scores={char=66,spell_lich_1_1=2,CC_silence=0,HP=4..}] run damage @a[scores={char=66},limit=1] 3 generic
execute at @a[scores={char=66,spell_lich_1_1=2,CC_silence=0,HP=3}] run damage @a[scores={char=66},limit=1] 2 generic
execute at @a[scores={char=66,spell_lich_1_1=2,CC_silence=0,HP=2}] run damage @a[scores={char=66},limit=1] 1 generic

execute at @a[scores={char=66,spell_lich_2_1=1,CC_silence=0,HP=4..}] run damage @a[scores={char=66},limit=1] 3 generic
execute at @a[scores={char=66,spell_lich_2_1=1,CC_silence=0,HP=3}] run damage @a[scores={char=66},limit=1] 2 generic
execute at @a[scores={char=66,spell_lich_2_1=1,CC_silence=0,HP=2}] run damage @a[scores={char=66},limit=1] 1 generic

scoreboard players remove @a[scores={lich_takedown=1..}] lich_takedown 1

execute at @a[scores={universal_hit=1..,char=66},team=yellow] run scoreboard players set @p[distance=..5,team=purple] lich_takedown 100
...
scoreboard players set @a[scores={char=66,spell_lich_1_1=1,CC_silence=1..}] spellCD1 20
scoreboard players set @a[scores={char=66,spell_lich_1_1=1,CC_silence=1..}] spell_lich_1_1 80

#execute at @a[scores={char=66,spell_lich_1_1=1,CC_silence=0},team=yellow] unless entity @a[distance=..8,team=purple] run scoreboard players set @a[scores={char=66,spell_lich_1_1=1,CC_silence=0}] spellCD1 20
#execute at @a[scores={char=66,spell_lich_1_1=1,CC_silence=0},team=yellow] unless entity @a[distance=..8,team=purple] run scoreboard players set @a[scores={char=66,spell_lich_1_1=1,CC_silence=0}] spell_lich_1_1 80

#execute at @a[scores={char=66,spell_lich_1_1=1,CC_silence=0},team=purple] unless entity @a[distance=..8,team=yellow] run scoreboard players set @a[scores={char=66,spell_lich_1_1=1,CC_silence=0}] spellCD1 20
#execute at @a[scores={char=66,spell_lich_1_1=1,CC_silence=0},team=purple] unless entity @a[distance=..8,team=yellow] run scoreboard players set @a[scores={char=66,spell_lich_1_1=1,CC_silence=0}] spell_lich_1_1 80



execute at @a[scores={char=66,spell_lich_1_1=1,CC_silence=0}] run playsound minecraft:item.trident.throw master @a[distance=..10] ~ ~ ~ 1 0.4 1
execute at @a[scores={char=66,spell_lich_1_1=1,CC_silence=0}] run summon minecraft:marker ~ ~ ~ {Tags:["lich_impale_rebar"],NoGravity:0b}
tp @e[tag=lich_impale_rebar,limit=1] @a[scores={char=66,spell_lich_1_1=2},limit=1]
execute at @a[scores={char=66,spell_lich_1_1=2,CC_silence=0}] as @e[tag=lich_impale_rebar,limit=1] at @s run tp @s ~ ~1.2 ~
...
execute at @a[scores={char=66,spell_lich_1_1=20..}] run kill @e[tag=lich_impale_rebar]


execute if entity @a[scores={char=66},team=yellow] at @e[tag=lich_impale_rebar] run damage @p[distance=..1.5,scores={lich_rebar_count=0},team=purple] 5 generic by @p[scores={char=66}] from @p[scores={char=66}]
execute if entity @a[scores={char=66},team=yellow] at @e[tag=lich_impale_rebar] run damage @p[distance=..1.5,scores={lich_rebar_count=1},team=purple] 6 generic by @p[scores={char=66}] from @p[scores={char=66}]
execute if entity @a[scores={char=66},team=yellow] at @e[tag=lich_impale_rebar] run damage @p[distance=..1.5,scores={lich_rebar_count=2},team=purple] 7 generic by @p[scores={char=66}] from @p[scores={char=66}]
execute if entity @a[scores={char=66},team=yellow] at @e[tag=lich_impale_rebar] run damage @p[distance=..1.5,scores={lich_rebar_count=3..},team=purple] 8 generic by @p[scores={char=66}] from @p[scores={char=66}]
execute if entity @a[scores={char=66},team=yellow] at @e[tag=lich_impale_rebar] run effect give @p[distance=..1.5,scores={lich_rebar_count=0},team=purple] minecraft:slowness 1 1 true
execute if entity @a[scores={char=66},team=yellow] at @e[tag=lich_impale_rebar] run effect give @p[distance=..1.5,scores={lich_rebar_count=1},team=purple] minecraft:slowness 2 1 true
execute if entity @a[scores={char=66},team=yellow] at @e[tag=lich_impale_rebar] run effect give @p[distance=..1.5,scores={lich_rebar_count=2},team=purple] minecraft:slowness 3 1 true
execute if entity @a[scores={char=66},team=yellow] at @e[tag=lich_impale_rebar] run effect give @p[distance=..1.5,scores={lich_rebar_count=3..},team=purple] minecraft:slowness 4 1 true
execute if entity @a[scores={char=66},team=yellow] at @e[tag=lich_impale_rebar] run scoreboard players add @p[distance=..1.5,team=purple] lich_rebar_count 1
execute if entity @a[scores={char=66},team=yellow] at @e[tag=lich_impale_rebar] run scoreboard players set @p[distance=..1.5,team=purple] lich_rebar_decay 0
execute if entity @a[scores={char=66},team=yellow] at @e[tag=lich_impale_rebar] if entity @a[distance=..1.5,team=purple] run playsound minecraft:item.trident.hit master @a[distance=..10] ~ ~ ~ 1 0.5 1
execute if entity @a[scores={char=66},team=yellow] at @e[tag=lich_impale_rebar] if entity @a[distance=..1.5,team=purple] run kill @e[tag=lich_impale_rebar]
...
scoreboard players set @a[scores={char=66,spell_lich_1_2=1,CC_silence=1..}] spellCD2 20
scoreboard players set @a[scores={char=66,spell_lich_1_2=1,CC_silence=1..}] spell_lich_1_1 40

execute at @a[scores={char=66,spell_lich_2_1=1,CC_silence=0}] run summon minecraft:marker ~ ~ ~ {Tags:["scrap_harvest","harvest_visuals"]}
execute at @a[scores={char=66,spell_lich_2_1=1,CC_silence=0}] run playsound minecraft:item.trident.return master @a[distance=..10] ~ ~ ~ 0.8 0.8 1
execute at @a[scores={char=66,spell_lich_2_1=1,CC_silence=0}] run playsound minecraft:item.armor.equip_chain master @a[distance=..10] ~ ~ ~ 1 0.5 1

scoreboard players add @e[tag=scrap_harvest] spell_lich_2 1
scoreboard players add @e[tag=scrap_harvest_return] spell_lich_2 1

execute as @e[tag=scrap_harvest,scores={spell_lich_2=1},limit=1] run tp @a[scores={char=66,spell_lich_2_1=1},limit=1]

execute as @e[tag=scrap_harvest,scores={spell_lich_2=2..10}] at @s run tp @s ^ ^ ^0.4
execute as @e[tag=scrap_harvest,scores={spell_lich_2=11..20}] at @s run tp @s ^ ^ ^0.35
execute as @e[tag=scrap_harvest,scores={spell_lich_2=21..}] at @s run tp @s ^ ^ ^0.3

execute at @e[tag=scrap_harvest,scores={spell_lich_2=30..},limit=1] run summon minecraft:marker ~ ~ ~ {Tags:["scrap_harvest_return","harvest_visuals"]}
kill @e[tag=scrap_harvest,scores={spell_lich_2=30..},limit=1]

execute as @e[tag=scrap_harvest_return] at @s run tp @s ~ ~ ~ facing entity @p[scores={char=66},limit=1]
execute as @e[tag=scrap_harvest_return,scores={spell_lich_2=2..10}] at @s run tp @s ^ ^ ^0.4
execute as @e[tag=scrap_harvest_return,scores={spell_lich_2=11..20}] at @s run tp @s ^ ^ ^0.45
execute as @e[tag=scrap_harvest_return,scores={spell_lich_2=21..}] at @s run tp @s ^ ^ ^0.5
...
#execute at @e[tag=harvest_visuals] if entity @a[scores={char=66},team=yellow] run scoreboard players set @a[distance=..2,team=purple] CC_exhaust 60
#execute at @e[tag=harvest_visuals] if entity @a[scores={char=66},team=yellow] run effect give @a[distance=..2,team=purple] minecraft:mining_fatigue 3 5
...
execute at @e[tag=scrap_harvest] if entity @a[scores={char=66},team=yellow] run scoreboard players set @a[distance=..2,scores={lich_scrap_damage=0},team=purple] lich_scrap_damage 1
execute at @e[tag=scrap_harvest] if entity @a[scores={char=66},team=yellow] run scoreboard players set @a[distance=..2,team=purple] lich_takedown 100
...
execute at @e[tag=scrap_harvest_return] if entity @a[scores={char=66},team=yellow] run scoreboard players set @a[distance=..2,scores={lich_scrap_damage2=0},team=purple] lich_scrap_damage2 1
execute at @e[tag=scrap_harvest_return] if entity @a[scores={char=66},team=yellow] run scoreboard players set @a[distance=..2,team=purple] lich_takedown 100
...
scoreboard players add @a[scores={spell_lich_1=1..}] spell_lich_1_1 1
item replace entity @a[scores={char=66,spell_lich_1_1=80..}] hotbar.1 with minecraft:andesite_wall[minecraft:custom_name={text:"Impale",color:"dark_aqua",bold:1b},minecraft:enchantments={"minecraft:impaling":1}] 1
scoreboard players set @a[scores={spell_lich_1_1=81..}] spell_lich_1 0
scoreboard players set @a[scores={spell_lich_1_1=81..}] spell_lich_1_1 0
scoreboard players set @a[scores={spell_lich_1_1=1}] spellCD1 80

scoreboard players add @a[scores={spell_lich_2=1..}] spell_lich_2_1 1
item replace entity @a[scores={char=66,spell_lich_2_1=60..}] hotbar.2 with minecraft:raw_iron[minecraft:custom_name={text:"Scrap Harvest",color:"dark_aqua",bold:1b}] 1
scoreboard players set @a[scores={spell_lich_2_1=61..}] spell_lich_2 0
scoreboard players set @a[scores={spell_lich_2_1=61..}] spell_lich_2_1 0
scoreboard players set @a[scores={spell_lich_2_1=1}] spellCD2 60
...
execute as @a[scores={char=66,spell_lich_1=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:andesite_wall",Slot:1b}]}] run clear @a[scores={char=66}] minecraft:andesite_wall
item replace entity @a[scores={char=66,spell_lich_1=0,spell_lich_1_1=0}] hotbar.1 with minecraft:andesite_wall[minecraft:custom_name={text:"Impale",color:"dark_aqua",bold:1b},minecraft:enchantments={"minecraft:impaling":1}] 1

execute as @a[scores={char=66,spell_lich_2=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:raw_iron",Slot:2b}]}] run clear @a[scores={char=66}] minecraft:raw_iron
item replace entity @a[scores={char=66,spell_lich_2=0}] hotbar.2 with minecraft:raw_iron[minecraft:custom_name={text:"Scrap Harvest",color:"dark_aqua",bold:1b}] 1