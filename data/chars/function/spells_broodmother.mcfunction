...
execute as @a[scores={char=41,s1_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=41}] carrot_on_a_stick[custom_data={s1:1}]
...
execute as @a[scores={char=41,s2_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=41}] warped_fungus_on_a_stick[custom_data={s2:1}]
...
execute as @a[scores={char=41,s3_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:deepslate_gold_ore",Slot:3b}]}] run clear @a[scores={char=41}] deepslate_gold_ore[custom_data={s3:1}]
