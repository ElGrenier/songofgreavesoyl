...
execute at @a[scores={char=47}] as @a[tag=valid_spell_target,distance=..5,scores={HPercentage=..50}] at @s unless score @s Team = @p[scores={char=47}] Team run particle falling_dust{block_state:{Name:"minecraft:sandstone"}} ~ ~0.3 ~ 0.5 0.8 0.5 1 1
execute at @a[scores={char=47}] as @a[tag=valid_spell_target,distance=..5,scores={HPercentage=..50}] at @s unless score @s Team = @p[scores={char=47}] Team run particle falling_dust{block_state:{Name:"minecraft:coal_block"}} ~ ~0.3 ~ 0.5 0.8 0.5 1 1
...
execute at @a[scores={char=47,s2_timer=1,CC_silence=0}] run playsound block.sand.place master @a[distance=..12] ~ ~ ~ 1 0.6 1
execute at @a[scores={char=47,s2_timer=3,CC_silence=0}] run playsound block.sand.place master @a[distance=..12] ~ ~ ~ 1 0.6 1
execute at @a[scores={char=47,s2_timer=5,CC_silence=0}] run playsound block.sand.place master @a[distance=..12] ~ ~ ~ 1 0.6 1
...
execute as @a[scores={embrace=15..19,death_dash_reset=0}] at @s run tp @e[tag=mummy_pull,sort=nearest,limit=1]
