...
execute at @a[scores={char=49}] unless entity @a[scores={char=49},predicate=chars:aberration_looking_at] as @p[distance=..0.6,scores={passive_aber_stack=1..}] run scoreboard players set @s passive_aber_display_timer 40
...
item replace entity @a[scores={char=49,aber_s2_buff=1..}] hotbar.0 with diamond_pickaxe[minecraft:custom_name={bold:1b,color:"gray",text:"Lashers"},minecraft:unbreakable={},minecraft:enchantments={"minecraft:efficiency":1},minecraft:custom_data={terminus:1},minecraft:attribute_modifiers=[{id:"armor",type:"minecraft:attack_damage",amount:2d,operation:"add_value",slot:"mainhand"},{id:"armor",type:"minecraft:attack_speed",amount:-0.55d,operation:"add_multiplied_base",slot:"mainhand"}],minimum_attack_charge=1] 1
...
scoreboard players remove @a[scores={passive_aber_display=1,passive_aber_display_timer=1..}] passive_aber_display_timer 1
...
execute unless entity @a[scores={passive_aber_display=1}] run title @a[scores={char=49}] actionbar [{text:" > ",bold:1b,color:"black",type:"text"},{text:" < ",bold:1b,color:"black",type:"text"},{text:" [",bold:1b,color:"black",type:"text"},{text:" - - - ",bold:1b,color:"dark_aqua",type:"text"},{text:"]",bold:1b,color:"black",type:"text"}]
