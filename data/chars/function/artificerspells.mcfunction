...
scoreboard players set @a[scores={char=48}] MaxHP 20
...
execute as @a[scores={char=48,s1_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=48}] carrot_on_a_stick
...
execute as @a[scores={char=48,s2_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=48}] warped_fungus_on_a_stick
