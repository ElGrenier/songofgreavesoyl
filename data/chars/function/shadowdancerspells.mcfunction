...
scoreboard players set @a[scores={s1_timer=1}] spellCD1 140
scoreboard players add @a[scores={s1_timer=1..}] s1_timer 1
scoreboard players set @a[scores={s1_timer=141..}] s1_timer 0

scoreboard players set @a[scores={s2_timer=1}] spellCD2 240
scoreboard players add @a[scores={s2_timer=1..}] s2_timer 1
scoreboard players set @a[scores={s2_timer=240..}] s2_timer 0
...
execute as @a[scores={char=55,s1_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=19}] carrot_on_a_stick
...
execute as @a[scores={char=55,s2_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=19}] warped_fungus_on_a_stick
