...
execute at @a[scores={char=4}] as @a[tag=valid_spell_target] unless score @s Team = @p[scores={char=4}] Team run tag @s add enemy_of_the_wrapper
execute at @a[scores={char=4}] as @a[tag=valid_spell_target] if score @s Team = @p[scores={char=4}] Team run tag @s remove enemy_of_the_wrapper
...
execute at @a[scores={char=4,s1_timer=1,CC_silence=0}] run summon marker ~ ~ ~ {Tags:["WarperMarker","entities_warper"]}
execute at @a[scores={char=4,s1_timer=1}] run tp @e[tag=WarperMarker] @p[scores={char=4}]

clear @a[scores={char=4,s1_timer=1..5,CC_silence=0}] *[custom_data={s1:1}]
execute as @a[scores={char=4,s1_timer=1,CC_silence=0}] at @s positioned ~ ~0.5 ~ run function chars:wrapper_blink_raycast
execute at @a[scores={char=4,s1_timer=2,CC_silence=0}] run playsound entity.enderman.teleport master @a[distance=..20] ~ ~ ~ 1 1.1 1
execute at @a[scores={char=4,s1_timer=2,CC_silence=0}] run particle portal ~ ~1 ~ 0.5 0.7 0.5 0.1 50 normal
execute at @a[scores={char=4,s1_timer=2,CC_silence=0}] run particle smoke ~ ~1 ~ 0.7 1 0.7 0.001 80 normal

data modify entity @e[tag=warper_blink,limit=1] Rotation set from entity @p[scores={char=4}] Rotation
execute at @e[tag=warper_blink,limit=1] run tp @a[scores={char=4}] ~ ~ ~
kill @e[tag=warper_blink]
...
item replace entity @a[scores={char=4,s2_timer=1..2,CC_silence=0}] armor.head with stone[item_model=air,minecraft:custom_name="aaaa",minecraft:enchantments={"minecraft:projectile_protection":2,"minecraft:binding_curse":1},minecraft:attribute_modifiers=[{id:"armor",type:"minecraft:max_health",amount:4.0d,operation:"add_value",slot:"head"}]] 1
...
execute as @a[scores={char=4,s1_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=4}] carrot_on_a_stick[custom_data={s1:1}]
item replace entity @a[scores={char=4,s1_timer=0,CC_silence=0}] hotbar.1 with carrot_on_a_stick[custom_data={s1:1},minecraft:item_model="minecraft:ender_pearl",minecraft:custom_name={text:"Void Warp",color:"dark_aqua",bold:1b},minecraft:enchantments={"minecraft:power":1}] 1
...
execute as @a[scores={char=4,s2_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=4}] warped_fungus_on_a_stick[custom_data={s2:1}]
