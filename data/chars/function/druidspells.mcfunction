...
execute at @a[scores={char=63,s1_timer=1,CC_silence=0}] run playsound minecraft:block.vine.place master @a[distance=..10] ~ ~ ~ 0.5 1.2 1
execute at @a[scores={char=63,s1_timer=1,CC_silence=0}] run playsound minecraft:block.flowering_azalea.place master @a[distance=..10] ~ ~ ~ 1 0.5 1
execute at @a[scores={char=63,s1_timer=1,CC_silence=0}] run summon minecraft:armor_stand ~ ~ ~ {Marker:1b,Invisible:1b,Tags:["tanglebarbs_projectile","entities_druid","projectile"],NoGravity:1b,Small:1b,Pose:{Head:[90.0f,0.0f,0.0f]},equipment:{head:{id:"minecraft:vine",count:1}}}
...
execute as @a[scores={char=63}] as @e[tag=tanglebarbs_projectile] at @s unless block ^ ^.5 ^.5 #minecraft:dash run summon minecraft:armor_stand ~ ~1 ~ {Small:1b,Marker:1b,Invisible:1b,Tags:["tanglebarbs_actual","entities_druid"],NoGravity:1b,Pose:{Head:[90.0f,0.0f,0.0f]},equipment:{head:{id:"minecraft:oak_leaves",count:1}}}
execute as @e[tag=tanglebarbs_projectile] at @s unless block ^ ^.5 ^.5 #minecraft:dash run kill @s
...
execute at @e[tag=tanglebarbs_actual,scores={s1_timer=1..120}] run particle minecraft:block{block_state:{Name:"minecraft:vine"}} ~ ~ ~ 2 0.2 2 0.05 90
execute at @e[tag=tanglebarbs_actual,scores={s1_timer=1..120}] run particle minecraft:block{block_state:{Name:"minecraft:hanging_roots"}} ~ ~ ~ 2 0.2 2 0.05 50


execute at @e[tag=tanglebarbs_actual,scores={s1_timer=2}] run playsound minecraft:block.vine.place master @a[distance=..12] ~ ~ ~ 1 0.5 1
execute at @e[tag=tanglebarbs_actual,scores={s1_timer=12}] run playsound minecraft:block.vine.break master @a[distance=..12] ~ ~ ~ 1 0.5 1
execute at @e[tag=tanglebarbs_actual,scores={s1_timer=22}] run playsound minecraft:block.vine.place master @a[distance=..12] ~ ~ ~ 1 0.5 1
execute at @e[tag=tanglebarbs_actual,scores={s1_timer=32}] run playsound minecraft:block.vine.place master @a[distance=..12] ~ ~ ~ 1 0.5 1
...
execute at @a[scores={char=63,s2_timer=1,CC_silence=0}] run playsound minecraft:entity.evoker.cast_spell master @a[distance=..10] ~ ~ ~ 1 0.1 1
...
execute at @a[scores={handofthorns=3..}] unless entity @e[distance=..1,tag=handofthorns_visual] run summon minecraft:marker ~ ~ ~ {Tags:["handofthorns_visual","entities_druid"]}
