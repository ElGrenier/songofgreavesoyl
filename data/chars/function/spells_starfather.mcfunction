...
execute as @a[scores={char=60,s2_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=60}] warped_fungus_on_a_stick[custom_data={s2:1}]
