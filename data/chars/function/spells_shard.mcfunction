...
execute as @e[tag=pillar_grenade,scores={s0_timer=1..14}] at @s run tp @s ^ ^ ^0.4
execute as @e[tag=pillar_grenade,scores={s0_timer=15..24}] at @s run tp @s ^ ^ ^0.25
execute as @e[tag=pillar_grenade,scores={s0_timer=15..24}] at @s run tp @s ~ ~-0.15 ~
execute as @e[tag=pillar_grenade,scores={s0_timer=25..}] at @s run tp @s ^ ^ ^0.2
execute as @e[tag=pillar_grenade,scores={s0_timer=25..}] at @s run tp @s ~ ~-0.25 ~
execute as @e[tag=pillar_grenade,scores={s0_timer=40..}] at @s run tp @s ~ ~-0.3 ~
execute as @e[tag=pillar_grenade,scores={s0_timer=1..14}] at @s run tp @s ^ ^ ^0.4
execute as @e[tag=pillar_grenade,scores={s0_timer=15..24}] at @s run tp @s ^ ^ ^0.25
execute as @e[tag=pillar_grenade,scores={s0_timer=15..24}] at @s run tp @s ~ ~-0.15 ~
execute as @e[tag=pillar_grenade,scores={s0_timer=25..}] at @s run tp @s ^ ^ ^0.2
...
execute as @e[tag=pillar,scores={PillarAge=1},limit=1] at @s run tp @s ~ ~ ~ facing entity @n[tag=pillar,scores={PillarAge=2},limit=1]
execute as @e[tag=pillar,scores={PillarAge=2},limit=1] at @s run tp @s ~ ~ ~ facing entity @n[tag=pillar,scores={PillarAge=1},limit=1]
...
execute at @e[tag=pillar] unless entity @e[distance=..0.5,tag=pillar_visual_1] run summon block_display ~ ~ ~ {brightness:{sky:15,block:15},teleport_duration:1,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.3f,0.6f,-0.3f],scale:[0.6f,0.9f,0.6f]},block_state:{Name:"minecraft:amethyst_block"},Tags:["pillar_visual_1","pillar_visuals","entities_shard"]}
execute at @e[tag=pillar] unless entity @e[distance=..0.5,tag=pillar_visual_2] run summon block_display ~ ~ ~ {brightness:{sky:15,block:15},teleport_duration:1,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.35f,-0.1f,-0.35f],scale:[0.7f,0.8f,0.7f]},block_state:{Name:"minecraft:amethyst_block"},Tags:["pillar_visual_2","pillar_visuals","entities_shard"]}
execute at @e[tag=pillar] run tp @e[distance=..0.5,tag=pillar_visual_1,limit=1] ~ ~ ~
execute at @e[tag=pillar] run tp @e[distance=..0.5,tag=pillar_visual_2,limit=1] ~ ~ ~



execute as @e[tag=pillar_visuals] at @s unless entity @e[tag=pillar,distance=..0.5] run playsound entity.vex.death master @a[distance=..12] ~ ~ ~ 0.2 2 1
execute as @e[tag=pillar_visuals] at @s unless entity @e[tag=pillar,distance=..0.5] run playsound block.amethyst_block.break master @a[distance=..12] ~ ~ ~ 1 0.8 1
execute as @e[tag=pillar_visuals] at @s unless entity @e[tag=pillar,distance=..0.5] run particle block{block_state:{Name:"minecraft:amethyst_block"}} ~ ~0.5 ~ 0.4 1.2 0.4 0.1 80 normal
execute as @e[tag=pillar_visuals] at @s unless entity @e[tag=pillar,distance=..0.5] run kill @s
...
execute at @a[scores={char=15,s1_timer=1}] unless entity @e[tag=pillar,scores={PillarAge=2}] run tag @a[scores={char=15}] add shart_no_pillars
execute at @a[scores={char=15,s1_timer=1}] unless entity @e[tag=pillar,scores={PillarAge=1}] run tag @a[scores={char=15}] add shart_no_pillars

scoreboard players set @a[scores={char=15},tag=shart_no_pillars] spellCD1 20
scoreboard players set @a[scores={char=15},tag=shart_no_pillars] s1_timer 300
tag @a remove shart_no_pillars
...
execute at @a[scores={char=15,s1_timer=1..100,CC_silence=0}] as @e[tag=pillar] at @s positioned ~ ~1.3 ~ run function chars:shard_gate_raycast
execute at @a[scores={char=15,s1_timer=1..100,CC_silence=0}] at @e[tag=pillar] run playsound minecraft:block.amethyst_block.resonate master @a[distance=..15] ~ ~ ~ 0.6 2 1
...
execute as @a[scores={char=15,s2_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=15}] warped_fungus_on_a_stick[custom_data={s2:1}]
