...
execute at @e[tag=sandstorm_source] run effect clear @a[distance=6.1..,scores={char=9}] invisibility

execute at @a[scores={char=9,s2_timer=120}] run effect clear @a[scores={char=9}] invisibility
