...
item replace entity @a[scores={char=666}] armor.head with minecraft:player_head[minecraft:custom_name="Head",minecraft:enchantments={"minecraft:projectile_protection":2,"minecraft:binding_curse":1},minecraft:attribute_modifiers=[{id:"armor",type:"minecraft:max_health",amount:12.0d,operation:"add_value",slot:"head"}],minecraft:profile={id:[I;-1626538924,-1410775545,-1984946359,940139578],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNjg2NjRmYjI2ZmNmMjFiYjY4NGFlOTE0N2FiZDQ5Njg3Y2M3YmJhMGIwMTE0ZGJlZjYxYzdkZDM4MWNhIn19fQ=="}]}] 1
item replace entity @a[scores={char=666}] armor.chest with minecraft:leather_chestplate[minecraft:custom_name="Armor",minecraft:dyed_color=8753460,minecraft:unbreakable={}] 1
