kill @e[type=minecraft:item,nbt={Item:{id:"minecraft:golden_chestplate"}}]
...
execute as @a[scores={char=1,CC_disarm=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:netherite_sword",Slot:0b}]}] run clear @a[scores={char=1}] minecraft:netherite_sword
...
execute as @a[scores={char=1,s1_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=1}] minecraft:carrot_on_a_stick
...
execute as @a[scores={char=1,s2_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=1}] minecraft:warped_fungus_on_a_stick
