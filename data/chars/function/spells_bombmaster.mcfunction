...
execute as @a[scores={char=11}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:bow",Slot:0b}]}] run clear @a[scores={char=11}] bow
...
execute as @a[scores={char=11,s1_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=11}] carrot_on_a_stick[custom_data={s1:1}]
...
execute as @a[scores={char=11,s2_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=11}] warped_fungus_on_a_stick[custom_data={s2:1}]
