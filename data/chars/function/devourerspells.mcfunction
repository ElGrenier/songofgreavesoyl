...
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..1] unless entity @e[tag=d_tentacle1] at @s positioned ^ ^ ^1 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle1","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..2] unless entity @e[tag=d_tentacle2] at @s positioned ^ ^ ^2 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle2","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..3] unless entity @e[tag=d_tentacle3] at @s positioned ^ ^ ^3 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle3","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..4] unless entity @e[tag=d_tentacle4] at @s positioned ^ ^ ^4 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle4","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..5] unless entity @e[tag=d_tentacle5] at @s positioned ^ ^ ^5 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle5","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..6] unless entity @e[tag=d_tentacle6] at @s positioned ^ ^ ^6 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle6","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..7] unless entity @e[tag=d_tentacle7] at @s positioned ^ ^ ^7 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle7","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..8] unless entity @e[tag=d_tentacle8] at @s positioned ^ ^ ^8 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle8","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..9] unless entity @e[tag=d_tentacle9] at @s positioned ^ ^ ^9 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle9","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..10] unless entity @e[tag=d_tentacle10] at @s positioned ^ ^ ^10 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle10","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..11] unless entity @e[tag=d_tentacle11] at @s positioned ^ ^ ^11 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle11","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..12] unless entity @e[tag=d_tentacle12] at @s positioned ^ ^ ^12 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle12","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..13] unless entity @e[tag=d_tentacle13] at @s positioned ^ ^ ^13 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle13","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..14] unless entity @e[tag=d_tentacle14] at @s positioned ^ ^ ^14 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle14","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..15] unless entity @e[tag=d_tentacle15] at @s positioned ^ ^ ^15 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle15","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..16] unless entity @e[tag=d_tentacle16] at @s positioned ^ ^ ^16 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle16","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..17] unless entity @e[tag=d_tentacle17] at @s positioned ^ ^ ^17 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle17","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..18] unless entity @e[tag=d_tentacle18] at @s positioned ^ ^ ^18 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle18","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
execute as @e[tag=devourer_tentacle_visual_core] at @s unless entity @a[scores={char=22},distance=..19] unless entity @e[tag=d_tentacle19] at @s positioned ^ ^ ^19 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["d_tentacle19","d_tentacle_visuals","entities_devourer"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.6f],scale:[0.8f,0.8f,1.2f]},block_state:{Name:"minecraft:black_concrete_powder"}}
