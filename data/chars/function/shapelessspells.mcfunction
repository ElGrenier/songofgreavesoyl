...
execute as @a[scores={char=37,s1_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=37}] carrot_on_a_stick
item replace entity @a[scores={char=37,s1_timer=0}] hotbar.1 with carrot_on_a_stick[custom_data={s1:1},minecraft:item_model="minecraft:crying_obsidian",minecraft:custom_name={text:"Into the Void",color:"dark_aqua",bold:1b}] 1


execute as @a[tag=!in_the_void,scores={char=37,s2_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=37}] warped_fungus_on_a_stick
item replace entity @a[tag=!in_the_void,scores={char=37,s2_timer=0}] hotbar.2 with warped_fungus_on_a_stick[custom_data={s2:1},minecraft:item_model="minecraft:netherite_ingot",minecraft:custom_name={text:"Remember Me",color:"dark_aqua",bold:1b}] 1
