...
#smite and ignite
scoreboard players set @a[scores={char=27,s1_timer=1,CC_silence=0}] champion_empower 1
...
scoreboard players set @a[scores={char=27,s1_timer=81,champion_empower=1}] champion_empower 0

execute at @a[scores={char=27,champion_empower=2..}] run playsound entity.blaze.shoot master @a[distance=..15] ~ ~ ~ 1 1.5 1
...
execute at @a[scores={char=27,s2_timer=1,CC_silence=0}] as @a[tag=valid_spell_target,distance=..7] if score @s Team = @p[scores={char=27}] Team run particle block{block_state:{Name:"minecraft:gold_block"}} ~ ~0.2 ~ 0.6 1.5 0.6 1 30
execute at @a[scores={char=27,s2_timer=1,CC_silence=0}] as @a[tag=valid_spell_target,distance=..7] if score @s Team = @p[scores={char=27}] Team run particle flame ~ ~0.2 ~ 0.6 1 0.6 0.1 30

execute at @a[scores={char=27,s2_timer=1,CC_silence=0}] run summon marker ~ ~0.5 ~ {Tags:["blessing_visual_core","blessingofflames_visuals","entities_champion"]}
execute at @a[scores={char=27,s2_timer=1,CC_silence=0}] run summon marker ~0.5 ~0.5 ~ {Tags:["blessing_visual_1","blessingofflames_visuals","entities_champion"]}
execute at @a[scores={char=27,s2_timer=1,CC_silence=0}] run summon marker ~-0.5 ~0.5 ~ {Tags:["blessing_visual_2","blessingofflames_visuals","entities_champion"]}
execute at @a[scores={char=27,s2_timer=1,CC_silence=0}] run summon marker ~ ~0.5 ~0.5 {Tags:["blessing_visual_3","blessingofflames_visuals","entities_champion"]}
execute at @a[scores={char=27,s2_timer=1,CC_silence=0}] run summon marker ~ ~0.5 ~-0.5 {Tags:["blessing_visual_4","blessingofflames_visuals","entities_champion"]}

execute at @e[tag=blessingofflames_visuals,tag=!blessing_visual_core] run particle small_flame ~ ~0.2 ~ 0.1 0.1 0.1 0.001 25
...
execute as @e[tag=blessingofflames_visuals,tag=!blessing_visual_core] at @s run tp @s ^0.3 ^ ^-0.07
execute at @e[tag=blessingofflames_visuals,tag=!blessing_visual_core] run particle small_flame ~ ~0.2 ~ 0.1 0.1 0.1 0.001 25
execute as @e[tag=blessingofflames_visuals,tag=!blessing_visual_core] at @s run tp @s ^0.3 ^ ^-0.07
execute at @e[tag=blessingofflames_visuals,tag=!blessing_visual_core] run particle small_flame ~ ~0.2 ~ 0.1 0.1 0.1 0.001 25
execute as @e[tag=blessingofflames_visuals,tag=!blessing_visual_core] at @s run tp @s ^0.3 ^ ^-0.07
...
execute as @a[scores={char=27,s1_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=27}] minecraft:carrot_on_a_stick
item replace entity @a[scores={char=27,s1_timer=0,CC_silence=0}] hotbar.1 with carrot_on_a_stick[custom_data={s1:1},minecraft:item_model="minecraft:blaze_rod",minecraft:custom_name={text:"Smite and Ignite",color:"dark_aqua",bold:1b},minecraft:enchantments={"minecraft:flame":1}] 1

execute as @a[scores={char=27,s2_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=27}] warped_fungus_on_a_stick
item replace entity @a[scores={char=27,s2_timer=0,CC_silence=0}] hotbar.2 with warped_fungus_on_a_stick[custom_data={s2:1},minecraft:item_model="minecraft:golden_helmet",minecraft:custom_name={text:"Blessing of Flames",color:"dark_aqua",bold:1b},minecraft:enchantments={"minecraft:sharpness":1}] 1
