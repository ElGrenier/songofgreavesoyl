...
kill @e[type=minecraft:item,nbt={Item:{id:"minecraft:tube_coral"}}]
...
execute at @a[scores={char=10}] as @a[distance=..6] unless score @s Team = @p[scores={char=10}] Team run tag @s add kraken_passive_stacking_valid_target
execute at @a[scores={char=10}] as @a[distance=6.1..] unless score @s Team = @p[scores={char=10}] Team run tag @s remove kraken_passive_stacking_valid_target
...
execute at @a[scores={char=10}] if entity @a[distance=..6,tag=kraken_passive_stacking_valid_target] run scoreboard players add @a[scores={char=10}] passive_krak 1
execute at @a[scores={char=10}] unless entity @a[distance=..6,tag=kraken_passive_stacking_valid_target] run scoreboard players remove @a[scores={char=10}] passive_krak 3

execute at @a[scores={char=10,kraken_tentacle=80}] as @a[distance=..6,tag=valid_spell_target] at @s unless score @s Team = @p[scores={char=10}] Team run summon block_display ~ ~-0.5 ~ {Tags:["tentacle_visuals","tentacle_visuals_2","entities_kraken"],teleport_duration:1,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.3f,-0.3f,-0.55f],scale:[0.5f,0.7f,0.5f]},block_state:{Name:"minecraft:warped_wart_block"}}
execute at @a[scores={char=10,kraken_tentacle=80}] as @a[distance=..6,tag=valid_spell_target] at @s unless score @s Team = @p[scores={char=10}] Team run summon block_display ~ ~-1 ~ {Tags:["tentacle_visuals","tentacle_visuals_2","entities_kraken"],teleport_duration:1,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.3f,-0.3f,-0.55f],scale:[0.55f,0.6f,0.55f]},block_state:{Name:"minecraft:warped_wart_block"}}
execute at @a[scores={char=10,kraken_tentacle=80}] as @a[distance=..6,tag=valid_spell_target] at @s unless score @s Team = @p[scores={char=10}] Team run summon block_display ~ ~-1.5 ~ {Tags:["tentacle_visuals","tentacle_visuals_2","entities_kraken"],teleport_duration:1,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.3f,-0.3f,-0.55f],scale:[0.6f,0.6f,0.6f]},block_state:{Name:"minecraft:warped_wart_block"}}
execute at @a[scores={char=10,kraken_tentacle=80}] as @a[distance=..6,tag=valid_spell_target] at @s unless score @s Team = @p[scores={char=10}] Team run summon block_display ~ ~-2 ~ {Tags:["tentacle_visuals","tentacle_visuals_2","entities_kraken"],teleport_duration:1,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.3f,-0.3f,-0.55f],scale:[0.65f,0.6f,0.65f]},block_state:{Name:"minecraft:warped_wart_block"}}
execute at @a[scores={char=10,kraken_tentacle=80}] as @a[distance=..6,tag=valid_spell_target] at @s unless score @s Team = @p[scores={char=10}] Team run summon block_display ~ ~-2.5 ~ {Tags:["tentacle_visuals","tentacle_visuals_2","entities_kraken"],teleport_duration:1,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.3f,-0.3f,-0.55f],scale:[0.65f,0.6f,0.65f]},block_state:{Name:"minecraft:warped_wart_block"}}


execute at @a[scores={char=10,kraken_tentacle=80}] as @a[distance=..6,tag=valid_spell_target] at @s unless score @s Team = @p[scores={char=10}] Team run particle minecraft:dust{color:[0.0,0.4,0.2],scale:1.0f} ~ ~ ~ 0.1 0.7 0.1 0.0001 500
execute at @a[scores={char=10,kraken_tentacle=80}] as @a[distance=..6,tag=valid_spell_target] unless score @s Team = @p[scores={char=10}] Team run scoreboard players set @s CC_stun 10

execute at @a[scores={char=10,passive_krak=80..}] run particle bubble ~ ~0.2 ~ 1 0.5 1 0.1 10
execute at @a[scores={char=10,passive_krak=80..}] run particle block{block_state:{Name:"minecraft:water"}} ~ ~0.1 ~ 1 0.5 1 0.1 40
execute at @a[scores={char=10,passive_krak=80..}] run particle block{block_state:{Name:"minecraft:water"}} ~ ~ ~ 3 0.5 3 0.1 80
...
execute as @e[tag=tentacle_visuals_2] at @s run tp @s ~ ~ ~ facing entity @p[scores={char=10}]
...
execute at @a[scores={char=10,s1_timer=1,CC_silence=0}] as @e[tag=kraken_tentacle,limit=1] at @s run tp @s ~ ~1.2 ~ 

execute at @e[tag=kraken_tentacle] run particle block{block_state:{Name:"minecraft:water"}} ~ ~ ~ 0.5 0.5 0.5 0.0001 10 normal
execute at @a[scores={char=10,s1_timer=10..}] at @e[tag=kraken_tentacle] run particle block{block_state:{Name:"minecraft:water"}} ^ ^ ^-2 0.5 0.5 0.5 0.0001 10 normal
execute as @e[tag=kraken_tentacle] at @s run tp @s ^ ^ ^0.4
...
execute as @e[tag=kraken_tentacle] at @s run tp @e[tag=kraken_tentacle_visual_core] ~ ~ ~ facing entity @p[scores={char=10}]

execute as @e[tag=kraken_tentacle_visual_core] at @s if entity @a[scores={char=10,s1_timer=3}] unless entity @e[tag=tentacle1] at @s positioned ^ ^ ^1 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["tentacle1","tentacle_visuals","tentacle_visuals_1","entities_kraken"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.3f,-0.3f,-0.55f],scale:[0.6f,0.6f,1.1f]},block_state:{Name:"minecraft:warped_wart_block"}}
execute as @e[tag=kraken_tentacle_visual_core] at @s if entity @a[scores={char=10,s1_timer=6}] unless entity @e[tag=tentacle2] at @s positioned ^ ^ ^2 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["tentacle2","tentacle_visuals","tentacle_visuals_1","entities_kraken"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.3f,-0.3f,-0.6f],scale:[0.6f,0.6f,1.2f]},block_state:{Name:"minecraft:warped_wart_block"}}
execute as @e[tag=kraken_tentacle_visual_core] at @s if entity @a[scores={char=10,s1_timer=9}] unless entity @e[tag=tentacle3] at @s positioned ^ ^ ^3 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["tentacle3","tentacle_visuals","tentacle_visuals_1","entities_kraken"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.3f,-0.3f,-0.6f],scale:[0.6f,0.6f,1.2f]},block_state:{Name:"minecraft:warped_wart_block"}}
execute as @e[tag=kraken_tentacle_visual_core] at @s if entity @a[scores={char=10,s1_timer=12}] unless entity @e[tag=tentacle4] at @s positioned ^ ^ ^4 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["tentacle4","tentacle_visuals","tentacle_visuals_1","entities_kraken"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.3f,-0.3f,-0.65f],scale:[0.6f,0.6f,1.3f]},block_state:{Name:"minecraft:warped_wart_block"}}
execute as @e[tag=kraken_tentacle_visual_core] at @s if entity @a[scores={char=10,s1_timer=15}] unless entity @e[tag=tentacle5] at @s positioned ^ ^ ^5 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["tentacle5","tentacle_visuals","tentacle_visuals_1","entities_kraken"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.3f,-0.3f,-0.65f],scale:[0.6f,0.6f,1.3f]},block_state:{Name:"minecraft:warped_wart_block"}}
execute as @e[tag=kraken_tentacle_visual_core] at @s if entity @a[scores={char=10,s1_timer=18}] unless entity @e[tag=tentacle6] at @s positioned ^ ^ ^6 run summon block_display ~ ~ ~ {teleport_duration:1,Tags:["tentacle6","tentacle_visuals","tentacle_visuals_1","entities_kraken"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.3f,-0.3f,-0.65f],scale:[0.6f,0.6f,1.3f]},block_state:{Name:"minecraft:warped_wart_block"}}

#execute as @e[tag=kraken_tentacle] run rotate @s facing entity @p[scores={char=10}]
#execute as @e[tag=kraken_tentacle] at @s store result entity @s Rotation[1] float 1 run clear
...
execute at @a[scores={char=10,s1_timer=20..25}] run kill @e[tag=kraken_tentacle]
execute at @a[scores={char=10,s1_timer=20..25}] run kill @e[tag=kraken_tentacle_visual_core]
execute at @a[scores={char=10,s1_timer=20..25}] run kill @e[tag=tentacle_visuals_1]
...
execute at @a[scores={char=10,s2_timer=2,CC_silence=0}] as @p[distance=0.5..6,tag=valid_spell_target] unless score @s Team = @p[scores={char=10}] Team run scoreboard players set @s abyss 1
...
execute at @a[scores={char=10,s2_timer=2,CC_silence=0}] run particle block{block_state:{Name:"minecraft:water"}} ~ ~0.3 ~ 4 0.5 4 0.00001 1000 force
