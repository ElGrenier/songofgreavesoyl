...
execute at @e[tag=slayer_slash] run particle entity_effect{color:[0.62,0.03,0.69,1.0]} ~ ~ ~ 0.3 0.3 0.3 0 1
...
scoreboard players set @e[tag=slayer_slashed] CC_silence 15
...
execute at @a[scores={char=1,s2_timer=10,CC_silence=0}] as @e[distance=..3.5,tag=valid_spell_target] unless score @s Team = @p[scores={char=1}] Team run tag @s add slayer_lunged
...
execute if entity @e[tag=slayer_lunged] run effect give @a[scores={char=1}] absorption 3 1 true
...
execute at @a[scores={char=1}] unless entity @e[tag=lunge_visual_1] run summon marker ~ ~ ~ {Tags:["lunge_visual_1","lunge_swords","entities_slayer"]}
execute at @a[scores={char=1}] unless entity @e[tag=lunge_visual_2] run summon marker ~ ~ ~ {Tags:["lunge_visual_2","lunge_swords","entities_slayer"]}

execute as @a[scores={char=1}] at @s run tp @e[tag=lunge_visual_core] ~ ~1 ~
execute as @e[tag=lunge_visual_core] at @s run tp @s ~ ~ ~ ~10 0
execute at @a[scores={char=1,s2_timer=10..25,CC_silence=0}] at @e[tag=lunge_swords] run particle entity_effect{color:[0.62,0.03,0.69,1.0]} ~ ~ ~ 0.2 0.2 0.2 0 1
execute at @a[scores={char=1,s2_timer=10..25,CC_silence=0}] at @e[tag=lunge_swords] run particle sweep_attack ~ ~ ~ 0.3 0.1 0.3 0.001 2 normal
execute at @a[scores={char=1,s2_timer=10..25,CC_silence=0}] at @e[tag=lunge_swords] run particle crit ~ ~ ~ 0.2 0.2 0.2 0.001 3 normal
execute as @e[tag=lunge_visual_core] at @s run tp @s ~ ~ ~ ~10 0
execute at @a[scores={char=1,s2_timer=10..25,CC_silence=0}] at @e[tag=lunge_swords] run particle sweep_attack ~ ~ ~ 0.3 0.1 0.3 0.001 2 normal
execute at @a[scores={char=1,s2_timer=10..25,CC_silence=0}] at @e[tag=lunge_swords] run particle crit ~ ~ ~ 0.2 0.2 0.2 0.001 3 normal
execute as @e[tag=lunge_visual_core] at @s run tp @s ~ ~ ~ ~10 0
...
execute as @e[tag=lunge_visual_core] at @s run tp @e[tag=lunge_visual_1] ^-0.3 ^ ^2
execute as @e[tag=lunge_visual_core] at @s run tp @e[tag=lunge_visual_2] ^-0.3 ^ ^-2
