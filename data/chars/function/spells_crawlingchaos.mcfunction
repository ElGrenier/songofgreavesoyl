...
execute as @a[tag=pharaoh,scores={char=50,s2_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=50}] warped_fungus_on_a_stick[custom_data={s2:1}]
...
execute as @a[tag=tongue,scores={char=50,s2_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=50}] warped_fungus_on_a_stick[custom_data={s2:1}]
...
execute as @a[tag=dweller,scores={char=50,s2_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=50}] warped_fungus_on_a_stick[custom_data={s2:1}]
...
execute as @a[tag=faceless,scores={char=50,s2_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=50}] warped_fungus_on_a_stick[custom_data={s2:1}]
...
#thousand faces
execute as @a[scores={char=50,s3_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:3b}]}] run clear @a[scores={char=51}] carrot_on_a_stick[custom_data={s3:1}]
