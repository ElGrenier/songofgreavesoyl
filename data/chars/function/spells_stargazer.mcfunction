...
item replace entity @a[scores={char=45}] hotbar.0 with golden_hoe[minecraft:custom_name={bold:1b,color:"gray",text:"Staff"},minecraft:unbreakable={},minecraft:attribute_modifiers=[{id:"armor",type:"minecraft:attack_damage",amount:1.5d,operation:"add_value",slot:"mainhand"},{id:"armor",type:"minecraft:attack_speed",amount:-0.7d,operation:"add_multiplied_base",slot:"mainhand"}],minimum_attack_charge=1] 1
...
item replace entity @a[scores={char=45,s2_timer=10..20,s2_timer_recast=0,CC_silence=0}] hotbar.2 with warped_fungus_on_a_stick[damage=0,max_damage=6,custom_data={s2:2},minecraft:item_model="minecraft:blue_stained_glass",minecraft:custom_name={text:"Pull",color:"dark_aqua",bold:1b}] 1
item replace entity @a[scores={char=45,s2_timer=21..40,s2_timer_recast=0,CC_silence=0}] hotbar.2 with warped_fungus_on_a_stick[damage=1,max_damage=6,custom_data={s2:2},minecraft:item_model="minecraft:blue_stained_glass",minecraft:custom_name={text:"Pull",color:"dark_aqua",bold:1b}] 1
item replace entity @a[scores={char=45,s2_timer=41..60,s2_timer_recast=0,CC_silence=0}] hotbar.2 with warped_fungus_on_a_stick[damage=2,max_damage=6,custom_data={s2:2},minecraft:item_model="minecraft:blue_stained_glass",minecraft:custom_name={text:"Pull",color:"dark_aqua",bold:1b}] 1
item replace entity @a[scores={char=45,s2_timer=61..80,s2_timer_recast=0,CC_silence=0}] hotbar.2 with warped_fungus_on_a_stick[damage=3,max_damage=6,custom_data={s2:2},minecraft:item_model="minecraft:blue_stained_glass",minecraft:custom_name={text:"Pull",color:"dark_aqua",bold:1b}] 1
item replace entity @a[scores={char=45,s2_timer=81..100,s2_timer_recast=0,CC_silence=0}] hotbar.2 with warped_fungus_on_a_stick[damage=4,max_damage=6,custom_data={s2:2},minecraft:item_model="minecraft:blue_stained_glass",minecraft:custom_name={text:"Pull",color:"dark_aqua",bold:1b}] 1
item replace entity @a[scores={char=45,s2_timer=101..120,s2_timer_recast=0,CC_silence=0}] hotbar.2 with warped_fungus_on_a_stick[damage=5,max_damage=6,custom_data={s2:2},minecraft:item_model="minecraft:blue_stained_glass",minecraft:custom_name={text:"Pull",color:"dark_aqua",bold:1b}] 1