...
item replace entity @a[scores={char=66}] hotbar.0 with bone[swing_animation={type:"stab"},minecraft:custom_name={bold:1b,color:"gray",text:"Bone"},minecraft:unbreakable={},minecraft:enchantments={"minecraft:protection":1},minecraft:attribute_modifiers=[{id:"armor",type:"minecraft:attack_damage",amount:1.5d,operation:"add_value",slot:"mainhand"},{id:"armor",type:"minecraft:attack_speed",amount:-0.6d,operation:"add_multiplied_base",slot:"mainhand"}],minimum_attack_charge=0.8] 1
