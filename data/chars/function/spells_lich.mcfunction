...
execute as @a[advancements={chars:lich_hit=true}] unless score @s Team = @p[scores={char=66}] Team run scoreboard players set @s lich_takedown 100
advancement revoke @a[advancements={chars:lich_hit=true}] only chars:lich_hit
...
scoreboard players set @e[tag=lich_impaled] lich_takedown 100
...
execute as @e[tag=scrap_harvest,scores={s2_timer=2..10}] at @s run tp @s ^ ^ ^0.45
execute as @e[tag=scrap_harvest,scores={s2_timer=11..20}] at @s run tp @s ^ ^ ^0.4
execute as @e[tag=scrap_harvest,scores={s2_timer=21..}] at @s run tp @s ^ ^ ^0.35
...
execute as @e[tag=scrap_harvest_return,scores={s2_timer=2..10}] at @s run tp @s ^ ^ ^0.5
execute as @e[tag=scrap_harvest_return,scores={s2_timer=11..20}] at @s run tp @s ^ ^ ^0.55
execute as @e[tag=scrap_harvest_return,scores={s2_timer=21..}] at @s run tp @s ^ ^ ^0.6
...
execute as @e[tag=scrap_harvest_return] at @s if entity @e[distance=..1.5,scores={char=66}] run effect give @a[scores={char=66,lich_scrap_shield=4}] absorption 6 3
execute as @e[tag=scrap_harvest_return] at @s if entity @e[distance=..1.5,scores={char=66}] run effect give @a[scores={char=66,lich_scrap_shield=5}] absorption 7 4
execute as @e[tag=scrap_harvest_return] at @s if entity @e[distance=..1.5,scores={char=66}] run effect give @a[scores={char=66,lich_scrap_shield=6}] absorption 8 4
execute as @e[tag=scrap_harvest_return] at @s if entity @e[distance=..1.5,scores={char=66}] run effect give @a[scores={char=66,lich_scrap_shield=7}] absorption 9 4
execute as @e[tag=scrap_harvest_return] at @s if entity @e[distance=..1.5,scores={char=66}] run effect give @a[scores={char=66,lich_scrap_shield=8..}] absorption 10 4
...
execute as @e[tag=scrap_harvest_return] at @s if entity @e[distance=..1.5,scores={char=66}] at @p[scores={char=66}] run particle glow ~ ~0.5 ~ 0.5 0.8 0.5 1 100
...
execute as @e[scores={lich_scrap_damage=2}] run damage @s 4 generic by @e[tag=scrap_wave,sort=nearest,limit=1] from @p[scores={char=66}]
...
execute as @e[scores={lich_scrap_damage2=2}] run damage @s 5 generic by @e[tag=scrap_wave,sort=nearest,limit=1] from @p[scores={char=66}]
...
scoreboard players set @a[scores={char=66,universal_death=1..}] lich_scrap_shield 0
