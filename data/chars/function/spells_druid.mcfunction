...
execute at @a[scores={char=63}] as @a[distance=..15,scores={CC_stun=1..}] unless score @s Team = @p[scores={char=63}] Team run scoreboard players set @s twisted_garden 60
execute at @a[scores={char=63}] as @a[distance=..15,scores={CC_root=1..}] unless score @s Team = @p[scores={char=63}] Team run scoreboard players set @s twisted_garden 60
execute at @a[scores={char=63}] as @a[distance=..15,scores={CC_taunt=1..}] unless score @s Team = @p[scores={char=63}] Team run scoreboard players set @s twisted_garden 60
execute at @a[scores={char=63}] as @a[distance=..15,scores={CC_charm=1..}] unless score @s Team = @p[scores={char=63}] Team run scoreboard players set @s twisted_garden 60
execute at @a[scores={char=63}] as @a[distance=..15,scores={CC_fear=1..}] unless score @s Team = @p[scores={char=63}] Team run scoreboard players set @s twisted_garden 60
execute at @a[scores={char=63}] as @a[distance=..15,scores={CC_knockup=1..}] unless score @s Team = @p[scores={char=63}] Team run scoreboard players set @s twisted_garden 60
execute at @a[scores={char=63}] as @a[distance=..15,scores={CC_grounded=1..}] unless score @s Team = @p[scores={char=63}] Team run scoreboard players set @s twisted_garden 60
execute at @a[scores={char=63}] as @a[distance=..15,scores={CC_entangled=1..}] unless score @s Team = @p[scores={char=63}] Team run scoreboard players set @s twisted_garden 60
...
execute at @a[scores={twisted_garden=1..}] run particle falling_spore_blossom ~ ~1 ~ 0.4 0.8 0.4 0.1 3
execute at @a[scores={twisted_garden=1..}] run particle scrape ~ ~1 ~ 0.5 0.8 0.5 0.1 1
...
execute as @e[tag=tanglebarbs_actual] at @s if block ~ ~-0.1 ~ #minecraft:dash run tp @s ~ ~-0.1 ~
execute as @e[tag=tanglebarbs_actual] at @s if block ~ ~-0.1 ~ #minecraft:dash run tp @s ~ ~-0.1 ~
execute as @e[tag=tanglebarbs_actual] at @s if block ~ ~-0.1 ~ #minecraft:dash run tp @s ~ ~-0.1 ~
execute as @e[tag=tanglebarbs_actual] at @s if block ~ ~-0.1 ~ #minecraft:dash run tp @s ~ ~-0.1 ~
...
execute at @e[tag=tanglebarbs_actual,scores={s1_timer=1..100}] as @e[distance=..5] unless score @s Team = @p[scores={char=63}] Team run effect give @s slowness 1 2
execute at @e[tag=tanglebarbs_actual,scores={s1_timer=1..100}] as @e[distance=..5] unless score @s Team = @p[scores={char=63}] Team run scoreboard players set @s CC_entangled 20
...
execute as @e[tag=druid_tangle] run attribute @s[tag=druid_tangle] knockback_resistance base set 100
execute as @e[tag=druid_tangle] run damage @s[tag=druid_tangle] 1 generic by @p[scores={char=63}] from @p[scores={char=63}]
execute as @e[tag=druid_tangle] run attribute @s[tag=druid_tangle] knockback_resistance base set 0
...
#execute as @e[tag=druid_root] unless score @s Team = @p[scores={char=63}] Team run scoreboard players set @s CC_entangled 20
...
execute at @a[scores={char=63}] as @a[distance=1..] if score @s Team = @p[scores={char=63}] Team run tag @s add druid_miasma_valid_target
execute at @a[scores={char=63}] as @a unless score @s Team = @p[scores={char=63}] Team run tag @s remove druid_miasma_valid_target

execute at @a[scores={char=63}] as @a[distance=0.5..,tag=valid_spell_target] if score @s Team = @p[scores={char=63}] Team run tag @s add druid_miasma_valid_target
execute at @a[scores={char=63}] as @a unless score @s Team = @p[scores={char=63}] Team run tag @s remove druid_miasma_valid_target

execute at @a[scores={char=63,s2_timer=1,CC_silence=0}] run playsound entity.evoker.cast_spell master @a[distance=..10] ~ ~ ~ 1 0.1 1
execute at @a[scores={char=63,s2_timer=1,CC_silence=0}] as @p[distance=0.5..8,tag=druid_miasma_valid_target] run scoreboard players set @s handofthorns 120
...
execute as @a[scores={handofthorns=3..}] run attribute @s attack_damage base set 1
execute as @a[scores={handofthorns=1..2}] run tag @s remove handofthorns_player
execute as @a[scores={handofthorns=1..2}] run attribute @s attack_damage base set 0
...
execute as @a[scores={char=63,s1_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=63}] carrot_on_a_stick[custom_data={s1:1}]
item replace entity @a[scores={char=63,s1_timer=0}] hotbar.1 with carrot_on_a_stick[custom_data={s1:1},minecraft:item_model="minecraft:vine",minecraft:custom_name={text:"Tangle of Thorns",color:"dark_aqua",bold:1b}] 1

execute as @a[scores={char=63,s2_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=63}] warped_fungus_on_a_stick[custom_data={s2:1}]
item replace entity @a[scores={char=63,s2_timer=0}] hotbar.2 with warped_fungus_on_a_stick[custom_data={s2:1},minecraft:item_model="minecraft:fern",minecraft:custom_name={text:"Miasma",color:"dark_aqua",bold:1b},minecraft:enchantments={"minecraft:thorns":1}] 1
