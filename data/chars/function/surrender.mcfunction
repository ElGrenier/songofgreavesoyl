...
execute unless score map_type settings matches 4 as @a[scores={surrender=1..13,cancel_sur=0,char=1..},tag=!PracticeRoom] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:6b}]}] run clear @s carrot_on_a_stick[custom_data={surrender_flag:2}]
execute unless score map_type settings matches 4 run item replace entity @a[scores={surrender=1..13,cancel_sur=0,char=1..},tag=!PracticeRoom] hotbar.6 with carrot_on_a_stick[minecraft:item_model="minecraft:red_banner",custom_data={surrender_flag:2},minecraft:custom_name={text:"Cancel Surrender Vote",color:"red",bold:1b},minecraft:lore=[{text:"Surrender vote must be unanimous",color:"gray"}]] 1
...
execute if score map_type settings matches 4 as @a[scores={surrender=1..,cancel_sur=0,char=1..13},tag=!PracticeRoom] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:6b}]}] run clear @s carrot_on_a_stick[custom_data={surrender_flag:2}]
