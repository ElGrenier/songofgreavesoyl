...
execute positioned ~-.5 ~-.5 ~-.5 as @a[dx=0,dy=0,dz=0,tag=valid_spell_target] unless score @s Team = @p[scores={char=38}] Team run scoreboard players set @s rite_of_chains 40
