...
#catch me if you can
effect give @a[scores={char=8,HPercentage=..60}] speed 1 0 true
effect give @a[scores={char=8,HPercentage=..20}] speed 1 1 true
...
scoreboard players set @a[scores={char=8,s1_timer=1..2}] s1_timer_recast 0
...
execute at @a[scores={char=8,s1_timer=1,CC_silence=0},x_rotation=44..90] run summon mannequin ~ ~ ~ {NoAI:1b,Silent:1b,Invulnerable:1b,Health:5.0f,Tags:["decoy","stationary_decoy","entities_trickstress"],equipment:{feet:{id:"minecraft:leather_boots",components:{"minecraft:dyed_color":8876137,"minecraft:trim":{material:"minecraft:copper",pattern:"minecraft:tide"}},count:1},legs:{id:"minecraft:leather_leggings",components:{"minecraft:dyed_color":12895428,"minecraft:trim":{material:"minecraft:copper",pattern:"minecraft:coast"}},count:1},chest:{id:"minecraft:leather_chestplate",components:{"minecraft:dyed_color":16777215,"minecraft:trim":{material:"minecraft:quartz",pattern:"minecraft:wayfinder"}},count:1},head:{id:"minecraft:player_head",components:{"minecraft:profile":{properties:[{name:"textures",value:"e3RleHR1cmVzOntTS0lOOnt1cmw6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZjg1YWUzMzZkOTdkZDM3ZjJlYTI1ZDBjOTVmZWE3MTgyMjYxNDNmNDQ1MWQzNzE3NWQ4MzJkM2M5N2QzOTgzIn19fQ=="}]}},count:1}}}
...
execute at @a[scores={char=8,s1_timer=1}] run particle soul_fire_flame ~ ~1 ~ 0.3 0.6 0.3 0.001 100 force

tag @a[scores={char=8,s1_timer=100}] remove invisible
execute at @a[scores={char=8,s1_timer=100..102}] at @e[tag=decoy] run playsound entity.phantom.death master @a[distance=..12] ~ ~ ~ 0.4 2 1
execute at @a[scores={char=8,s1_timer=100..102}] at @e[tag=decoy] run particle soul_fire_flame ~ ~0.7 ~ 0.4 0.8 0.4 0.001 50 force
execute at @a[scores={char=8,s1_timer=102}] run tp @e[tag=decoy] ~ ~-200 ~
execute at @a[scores={char=8,s1_timer=102}] run kill @e[tag=decoy]
...
execute at @a[scores={char=8,s1_timer_recast=1,CC_silence=0}] at @e[tag=decoy,limit=1] run particle soul_fire_flame ~ ~0.5 ~ 0.7 0.9 0.7 0.01 80 force
execute at @a[scores={char=8,s1_timer_recast=1,CC_silence=0}] run particle soul_fire_flame ~ ~0.5 ~ 0.7 0.9 0.7 0.01 60 force
...
execute at @a[scores={char=8,s2_timer=1,CC_silence=0}] run summon marker ~ ~ ~ {Tags:["SwapMarker","entities_trickstress"]}
execute as @a[scores={char=8,s2_timer=1,CC_silence=0}] at @s positioned ~ ~1.3 ~ run function chars:trickstress_swap_raycast

execute at @a[scores={char=8,s2_timer=1,CC_silence=0}] unless entity @e[tag=trickstress_swap_victim] run scoreboard players set @a[scores={char=8}] spellCD2 10
execute at @a[scores={char=8,s2_timer=1,CC_silence=0}] unless entity @e[tag=trickstress_swap_victim] run scoreboard players set @a[scores={char=8}] s2_timer 390
...
execute at @a[tag=trickstress_swap_victim] run tp @p[scores={char=8}] ~ ~ ~
execute at @a[scores={char=8,s2_timer=1,CC_silence=0}] as @p[distance=..2,tag=valid_spell_target,tag=trickstress_swap_victim] run tp @s @e[tag=SwapMarker,limit=1]
kill @e[tag=SwapMarker]
tag @a remove trickstress_swap_victim
...
item replace entity @a[scores={char=8}] hotbar.0 with minecraft:iron_sword[swing_animation={type:"stab"},minecraft:custom_name={bold:1b,color:"gray",text:"Knife"},minecraft:unbreakable={},minecraft:attribute_modifiers=[{id:"armor",type:"minecraft:attack_damage",amount:2.0d,operation:"add_value",slot:"mainhand"},{id:"armor",type:"minecraft:attack_speed",amount:-0.4d,operation:"add_multiplied_base",slot:"mainhand"}],minimum_attack_charge=1] 1

execute as @a[scores={char=8,s1_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=8}] carrot_on_a_stick[custom_data={s1:1}]
...
execute as @a[scores={char=8,s1_timer=10..99,s1_timer_recast=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=8}] carrot_on_a_stick[custom_data={s1:2}]
item replace entity @a[scores={char=8,s1_timer=10..20,s1_timer_recast=0,CC_silence=0}] hotbar.1 with carrot_on_a_stick[damage=0,max_damage=5,custom_data={s1:2},minecraft:item_model="minecraft:light_blue_concrete_powder",minecraft:custom_name={text:"Soul Swap",color:"dark_aqua",bold:1b},minecraft:enchantments={"minecraft:binding_curse":1}] 1
item replace entity @a[scores={char=8,s1_timer=21..40,s1_timer_recast=0,CC_silence=0}] hotbar.1 with carrot_on_a_stick[damage=1,max_damage=5,custom_data={s1:2},minecraft:item_model="minecraft:light_blue_concrete_powder",minecraft:custom_name={text:"Soul Swap",color:"dark_aqua",bold:1b},minecraft:enchantments={"minecraft:binding_curse":1}] 1
item replace entity @a[scores={char=8,s1_timer=41..60,s1_timer_recast=0,CC_silence=0}] hotbar.1 with carrot_on_a_stick[damage=2,max_damage=5,custom_data={s1:2},minecraft:item_model="minecraft:light_blue_concrete_powder",minecraft:custom_name={text:"Soul Swap",color:"dark_aqua",bold:1b},minecraft:enchantments={"minecraft:binding_curse":1}] 1
item replace entity @a[scores={char=8,s1_timer=61..80,s1_timer_recast=0,CC_silence=0}] hotbar.1 with carrot_on_a_stick[damage=3,max_damage=5,custom_data={s1:2},minecraft:item_model="minecraft:light_blue_concrete_powder",minecraft:custom_name={text:"Soul Swap",color:"dark_aqua",bold:1b},minecraft:enchantments={"minecraft:binding_curse":1}] 1
item replace entity @a[scores={char=8,s1_timer=81..99,s1_timer_recast=0,CC_silence=0}] hotbar.1 with carrot_on_a_stick[damage=4,max_damage=5,custom_data={s1:2},minecraft:item_model="minecraft:light_blue_concrete_powder",minecraft:custom_name={text:"Soul Swap",color:"dark_aqua",bold:1b},minecraft:enchantments={"minecraft:binding_curse":1}] 1

execute as @a[scores={char=8,s2_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=8}] warped_fungus_on_a_stick[custom_data={s1:1}]
