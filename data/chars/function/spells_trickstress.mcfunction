...
item replace entity @a[scores={char=8,s1_timer=1..2,CC_silence=0}] armor.head with stone[item_model=air,minecraft:custom_name="aaaa",minecraft:enchantments={"minecraft:projectile_protection":2,"minecraft:binding_curse":1},minecraft:attribute_modifiers=[{id:"armor",type:"minecraft:max_health",amount:10.0d,operation:"add_value",slot:"head"}]] 1
...
execute at @a[scores={char=8,s1_timer=100..102}] at @e[tag=decoy] run particle soul_fire_flame ~ ~ ~ 0.5 1 0.5 0.001 80 force
