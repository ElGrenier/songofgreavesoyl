kill @e[type=minecraft:item,nbt={Item:{id:"minecraft:ghast_tear"}}]
kill @e[type=minecraft:item,nbt={Item:{id:"minecraft:cyan_stained_glass_pane"}}]
kill @e[type=minecraft:item,nbt={Item:{id:"minecraft:blue_ice"}}]
kill @e[type=minecraft:item,nbt={Item:{id:"minecraft:prismarine_wall"}}]
...
execute at @a[scores={char=21,universal_hit=1..},team=purple] run scoreboard players set @a[distance=..7,team=yellow] curse 120
execute at @a[scores={char=21,universal_hit=1..},team=yellow] run scoreboard players set @a[distance=..7,team=purple] curse 120
...
item replace entity @a[scores={char=21}] hotbar.0 with bone[minecraft:custom_name={bold:1b,color:"gray",text:"Bone"},minecraft:enchantments={"minecraft:frost_walker":1},minecraft:attribute_modifiers=[{id:"armor",type:"minecraft:attack_speed",amount:-0.7d,operation:"add_multiplied_base",slot:"mainhand"},{id:"armor",type:"minecraft:attack_damage",amount:2.0d,operation:"add_value",slot:"mainhand"}]] 1

execute as @a[scores={char=21,s1_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=21}] carrot_on_a_stick[custom_data={s1:1}]
item replace entity @a[scores={char=21,s1_timer=0}] hotbar.1 with carrot_on_a_stick[custom_data={s1:1},minecraft:item_model="minecraft:ghast_tear",minecraft:custom_name={text:"Chilled Path",color:"dark_aqua",bold:1b},minecraft:enchantments={"minecraft:frost_walker":1}] 1

execute as @a[scores={char=21,s2_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=21}] warped_fungus_on_a_stick
item replace entity @a[scores={char=21,s2_timer=0}] hotbar.2 with warped_fungus_on_a_stick[custom_data={s2:1},minecraft:item_model="minecraft:blue_ice",minecraft:custom_name={text:"Frozen Tomb",color:"dark_aqua",bold:1b},minecraft:enchantments={"minecraft:frost_walker":1}] 1

execute as @a[scores={char=21,s3_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:3b}]}] run clear @a[scores={char=21}] carrot_on_a_stick[custom_data={s3:1}]
item replace entity @a[scores={char=21,s3_timer=0}] hotbar.3 with carrot_on_a_stick[custom_data={s3:1},minecraft:item_model="minecraft:prismarine_wall",minecraft:custom_name={text:"Children of the Grave",color:"dark_aqua",bold:1b},minecraft:enchantments={"minecraft:frost_walker":1}] 1