...
scoreboard players set @a[scores={char=58}] MaxHP 26
...
execute as @a[scores={char=58,s2_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=58}] warped_fungus_on_a_stick
