...
item replace entity @a[scores={char=31,s2_timer=20..40,s2_timer_recast=0,CC_silence=0}] hotbar.2 with warped_fungus_on_a_stick[damage=0,max_damage=4,custom_data={s2:2},minecraft:item_model="minecraft:lightning_rod",minecraft:custom_name={text:"Emerge",color:"dark_aqua",bold:1b}] 1
item replace entity @a[scores={char=31,s2_timer=41..60,s2_timer_recast=0,CC_silence=0}] hotbar.2 with warped_fungus_on_a_stick[damage=1,max_damage=4,custom_data={s2:2},minecraft:item_model="minecraft:lightning_rod",minecraft:custom_name={text:"Emerge",color:"dark_aqua",bold:1b}] 1
item replace entity @a[scores={char=31,s2_timer=61..80,s2_timer_recast=0,CC_silence=0}] hotbar.2 with warped_fungus_on_a_stick[damage=2,max_damage=4,custom_data={s2:2},minecraft:item_model="minecraft:lightning_rod",minecraft:custom_name={text:"Emerge",color:"dark_aqua",bold:1b}] 1
item replace entity @a[scores={char=31,s2_timer=81..97,s2_timer_recast=0,CC_silence=0}] hotbar.2 with warped_fungus_on_a_stick[damage=3,max_damage=4,custom_data={s2:2},minecraft:item_model="minecraft:lightning_rod",minecraft:custom_name={text:"Emerge",color:"dark_aqua",bold:1b}] 1
