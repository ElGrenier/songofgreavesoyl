...
scoreboard players add @a[scores={tridentcd=1..,CC_exhaust=0}] tridentcd 2
scoreboard players add @a[scores={tridentcd=1..,CC_exhaust=1..}] tridentcd 1
...
scoreboard players set @a[scores={char=17,tridentcd=30..}] tridentcd 0
...
execute as @a[scores={char=73,arrowcd=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:tipped_arrow",Slot:8b}]}] run clear @a[scores={char=73}] tipped_arrow
