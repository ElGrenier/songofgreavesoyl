...
execute at @a[scores={char=13,s1_timer=1,CC_silence=0}] as @p[distance=0.5..5,tag=valid_spell_target] unless score @s Team = @p[scores={char=13}] Team run tag @s add fear_source_skeletalphantom
execute at @a[scores={char=13,s1_timer=1,CC_silence=0}] as @p[distance=0.5..5,tag=valid_spell_target] unless score @s Team = @p[scores={char=13}] Team run scoreboard players set @s CC_fear 10

scoreboard players set @a[tag=skeletal_fear] CC_disarm 30
execute at @a[tag=skeletal_fear] at @s run particle smoke ~ ~1.5 ~ 0.5 0.5 0.5 0.01 50 force
tag @a remove skeletal_fear

execute as @a[tag=fear_source_skeletalphantom,scores={CC_fear=1..}] at @s run tp @s ~ ~ ~ facing entity @p[distance=0.5..,scores={char=13}]
execute as @a[tag=fear_source_skeletalphantom,scores={CC_fear=1..}] at @s run tp @s ~ ~ ~ ~-180 ~
tag @e[scores={CC_fear=..1}] remove fear_source_skeletalphantom
