...
execute as @a[scores={char=27,s2_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=27}] warped_fungus_on_a_stick[custom_data={s2:1}]
