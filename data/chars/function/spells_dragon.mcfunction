...
execute as @a[scores={char=7,s1_timer=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:bow",Slot:0b}]}] run clear @a[scores={char=7}] bow
...
execute as @a[scores={char=7,s1_timer=1..160}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:bow",Slot:0b}]}] run clear @a[scores={char=7}] bow
...
execute as @a[scores={char=7,s1_timer=161..}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:bow",Slot:0b}]}] run clear @a[scores={char=7}] bow
...
execute as @a[scores={char=7,s1_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick",Slot:1b}]}] run clear @a[scores={char=7}] carrot_on_a_stick[custom_data={s1:1}]
item replace entity @a[scores={char=7,s1_timer=0,CC_silence=0}] hotbar.1 with carrot_on_a_stick[custom_data={s1:1},minecraft:item_model="minecraft:fire_coral_fan",minecraft:custom_name={text:"Flurry of Flames",color:"dark_aqua",bold:1b}] 1

execute as @a[scores={char=7,s2_timer=0,CC_silence=0}] at @s unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Slot:2b}]}] run clear @a[scores={char=7}] warped_fungus_on_a_stick[custom_data={s2:1}]
item replace entity @a[scores={char=7,s2_timer=0,CC_silence=0}] hotbar.2 with warped_fungus_on_a_stick[custom_data={s2:1},minecraft:item_model="minecraft:elytra",minecraft:custom_name={text:"Tyrant's Departure",color:"dark_aqua",bold:1b}] 1
