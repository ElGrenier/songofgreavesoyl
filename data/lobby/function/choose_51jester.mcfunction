...
execute if entity @a[scores={char=51}] run tp @p[distance=..3] 242.4 14 -125.5
...
#execute if entity @a[scores={char=51},distance=..3] run tellraw @a [{"text":"=","color":"gray"},{"text":" "},{"selector":"@p[scores={char=51}]","color":"aqua"},{"text":" picked ","color":"gray"},{"text":"Jir","bold":true,"color":"dark_aqua"},{"text":",","color":"gray"},{"text":" The Jester","bold":true,"color":"aqua"},{"text":" =","color":"gray"}]
