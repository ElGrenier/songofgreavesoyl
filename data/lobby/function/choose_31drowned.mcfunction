...
execute if entity @a[scores={char=31}] run tp @p[distance=..3] 242.4 14 -125.5
scoreboard players set @p[distance=..3] char 31
scoreboard players set @p[distance=..3,tag=!PracticeCharPick] Queue 0
#execute if entity @a[scores={char=31},distance=..3] run tellraw @a [{"text":"=","color":"gray"},{"text":" "},{"selector":"@p[scores={char=31}]","color":"aqua"},{"text":" picked ","color":"gray"},{"text":"Anser","bold":true,"color":"dark_aqua"},{"text":",","color":"gray"},{"text":" The Drowned Captain","bold":true,"color":"aqua"},{"text":" =","color":"gray"}]
