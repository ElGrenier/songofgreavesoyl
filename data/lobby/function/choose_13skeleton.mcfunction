...
execute if entity @a[scores={char=13}] run tp @p[distance=..3] 242.4 14 -125.5
scoreboard players set @p[distance=..3] char 13
scoreboard players set @p[distance=..3,tag=!PracticeCharPick] Queue 0
#execute if entity @a[scores={char=13},distance=..3] run tellraw @a [{"text":"=","color":"gray"},{"text":" "},{"selector":"@p[scores={char=13}]","color":"aqua"},{"text":" picked ","color":"gray"},{"text":"Ranhart","bold":true,"color":"dark_aqua"},{"text":",","color":"gray"},{"text":" The Skeletal Phantom","bold":true,"color":"aqua"},{"text":" =","color":"gray"}]
