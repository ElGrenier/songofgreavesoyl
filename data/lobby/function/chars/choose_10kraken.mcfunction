...
execute if entity @a[scores={char=10}] run tp @p[distance=..3] 242.4 14 -125.5
scoreboard players set @p[distance=..3] char 10
scoreboard players set @p[distance=..3,tag=!PracticeCharPick] Queue 0
#execute if entity @a[scores={char=10},distance=..3] run tellraw @a [{"text":"=","color":"gray"},{"text":" "},{"selector":"@p[scores={char=10}]","color":"aqua"},{"text":" picked ","color":"gray"},{"text":"The Kraken","bold":true,"color":"dark_aqua"},{"text":",","color":"gray"},{"text":" Beast of The Abyss","bold":true,"color":"aqua"},{"text":" =","color":"gray"}]
