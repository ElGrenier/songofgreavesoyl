...
execute if score map settings matches 30 run scoreboard players set map_type settings 1
...
execute if score map lobby matches 30 run scoreboard players set map_type lobby 1
