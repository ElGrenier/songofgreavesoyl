...
execute if score game_state settings matches 7.. positioned 207 34 -130 run function chars:all_chars_spells
execute if score game_state settings matches 7.. positioned 207 34 -130 run function chars:all
...
execute if score game_state settings matches 2 run function battlegrounds:setup
...
execute if score game_state settings matches 7 run function core:score/manage_score


#Game Win management
execute if score game_state settings matches 8 run scoreboard players add loading settings 1
execute if score game_state settings matches 8 if score loading settings matches 160.. run function reset:reset

execute if score game_state settings matches 8 if score purple score >= score_max settings run scoreboard players operation purple score = score_max settings
execute if score game_state settings matches 8 if score yellow score >= score_max settings run scoreboard players operation yellow score = score_max settings
