...
execute if score game_state settings matches 8 if score map_type settings matches 4 as @a[tag=!madness_ffa] store result score @s Team run scoreboard players get @s char
