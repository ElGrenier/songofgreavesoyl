...
execute as @a unless entity @s[nbt={active_effects:[{id:"minecraft:resistance"}]}] run scoreboard players set @s resistance 0
...
execute as @a if entity @s[nbt={active_effects:[{id:"minecraft:resistance",amplifier:100b}]}] run scoreboard players set @s resistance 100
